  ...
  <div id="divLayoutTea" ref="refDivLayout" class="divComContainer">
    ...
    <div>
      ...
      <div id="DiscussEdit" class="DiscussEdit ml-3">
        <table style="width: 950%" class="table table-bordered table-hover table td table-sm">
          <tr>
            <td style="width: 70%">
              <textarea
...
<script lang="ts">
  ...
  // import { Question_QA } from '@/views/MiddleSchoolReading/Question_QA';
  import { Question_QA } from './Question_QA';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      onMounted(() => {
        Question_QA.vuebtn_Click = btn_Click;
        // CommQuestionAnswer.setVuebtn_Click(btn_Click);
        Question_QA.divLayout = refDivLayout.value;
        Question_QA.questionTypeId = props.questionTypeId;
        window_onload();
      });
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        switch (strCommandName) {
          ...
          case 'UpdateQuestions':
            Question_QA.EditObj = qa_Questions_EditRef.value;
            qa_Questions_Edit.EditObj = qa_Questions_EditRef.value;
            Question_QA.questionTypeId = props.questionTypeId;
            console.log('Question_QA.EditRef:', Question_QA.EditObj);
            break;
          case 'AddNewAnswer':
          case 'UpdateQa_Answer':
            Question_QA.EditObj = qa_Answer_EditRef.value;
        ...
        Question_QA.btn_Click(strCommandName, strKeyId, refDivLayout.value);
      }
      // 方法定义
    ...
    methods: {
      ...
      changeTab(tabId: string) {
        ...
        Question_QA.btn_Click('changeTab', tabId, this.refDivLayout);
      },
      /*
        *
     显示对话框
    ...
    */
     ...
     */
      ...
      getHighLight(source: any, temp: any) {
        const ColorCode = $('#hidColorCode').val();
        const strUserId = $('#hidUserId').val();
        let result = '';
      ...
      //将a的指定部分与b进行比较生成比对结果
      getDiff(a: any, b: any, start: any, end: any) {
      ...
      AddQ() {
        ...
        HideDivInDivObj(Question_QA.divLayout, 'div_qa_Answer');
        $('#div_qa_Welcome').hide();
      ...
      btnShowAnswer_Click(strKey: string, pageNum: number, pdfContent: string) {
        $('#div_qa_Welcome').hide();
        ShowDivInDivObj(Question_QA.divLayout, 'div_qa_Answer');
  ...
  */
      btnUpMove_Click(strKeyId: string, OrderNum: number) {
        ...
        if (OrderNum == 1) {
          ...
          // const objPage = new Question_QA();
          Question_QA.btnUpMove_Click(strKeyId, OrderNum);
        }
      },
  ...
  */
      btnDownMove_Click(strKeyId: string, OrderNum: number) {
        ...
        // const objPage = new Question_QA();
        Question_QA.btnDownMove_Click(strKeyId, OrderNum);
      },

      //刷新本页面回答
      Refresh_vTea_QA() {
        // const objPage = new Question_QA();
        Question_QA.btnShowAnswer_Click('', 0, '', enumCommentOrder.AllComment_01);
      },
