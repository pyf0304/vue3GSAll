...
*/
export class Question_QA implements IShowList {
  ...
  async BindGvCache(strType: string, strPara: string) {
    ...
    switch (strType) {
      ...
      case clsqa_AnswerEN._CurrTabName:
        ...
        await Question_QA.btnShowAnswer_Click(
          Question_QA.questionsId,
          0,
          '',
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    ...
    // CommQuestionAnswer.vuebtn_Click = Question_QA.btn_Click;
    console.log(objPage);
    if (Question_QA.divDataLst != null) {
      const arrKeyIds = GetCheckedKeyIdsInDivObj(Question_QA.divDataLst);
      console.log(arrKeyIds);
      strKeyId = GetFirstCheckedKeyIdInDivObj(Question_QA.divDataLst);
    }
    const qa_PaperId = ''; //待定
    let strMsg;
    let strAnswerId;
    ...
    switch (strCommandName) {
      case 'changeTab':
        if (Question_QA.questionsId == '') {
          strMsg = `请选择一个题目！`;
          message.info(strMsg);
          return;
        }
        strQuestionsId = Question_QA.questionsId;
        switch (strTabId) {
          case 'liAnswer': // '问题回答'
            strAnswerTypeId = '01';
            Question_QA.answerTypeId = strAnswerTypeId;
            ...
            HideDivInDivObj(Question_QA.divLayout, 'DiscussEdit');
          ...
          case 'liDiscuss2': // '组内讨论区'
            ...
            ShowDivInDivObj(Question_QA.divLayout, 'DiscussEdit');
            $('#btnAddAnswer').hide();
      ...
      case 'ShowAnswer':
        ...
        strPdfContent = arr[2];
        Question_QA.btnShowAnswer_Click(
          strQuestionsId,
          intPdfPageNum,
          strPdfContent,
          enumCommentOrder.AllComment_01,
      ...
      case 'Create': //添加记录
        ...
        objQa_questions.questionsTypeId = Question_QA.questionTypeId;
        console.log(objQa_questions);
        Question_QA.EditObj.btnqa_Questions_Edit_Click(strCommandName, strKeyId);
        break;
      ...
      case 'UpdateQa_Answer':
        ...
        objQa_Answer.questionsId = Question_QA.questionsId;
        console.log(objQa_Answer);
        Question_QA.EditObj.btnqa_Answer_Edit_Click(strCommandName, strKeyId);
        break;
      case 'UpdateAnswer': //
      ...
      case 'AddNewAnswer': //
        // HideDivInDivObj(objLayOut, 'div_qa_Answer');
        // Question_QA.questionsId = CommQuestionAnswer.questionsId;
        $('#divEditAnswerRegion').show();
        // qa_Questions_EditEx.btnEdit_Click('AddNewAnswer', '');
        clsPrivateSessionStorage.questionsTypeId = '03';
        qa_Answer_EditEx.parentId = 'root';
        ...
        objQa_Answer.questionsId = Question_QA.questionsId;
        console.log(objQa_Answer);
        console.log('Question_QA.EditObj', Question_QA.EditObj);
        Question_QA.EditObj.btnqa_Answer_Edit_Click(strCommandName, strKeyId);
        break;
      ...
      default:
        AccessBtnClickDefault(strCommandName, 'Question_QA.btn_Click');
  ...
  public async Bind_Show3List(
    ...
    switch (strAnswerTypeId) {
      case '01':
        await Question_QA.btnShowAnswer_Click(strQuestionId, 0, '', strCommentOrder);
        break;
      case '02':
  ...
  public async BindDiv_Questions(
    ...
    try {
      ...
      await objPage.BindDiv_Questions(
        Question_QA.vuebtn_Click,
        Question_QA.divLayout,
        div_qa_Questions,
  ...
  public async Showdiv_Questions() {
    const divName = this.getDivName(enumDivType.LayOut_01);
    //strWhereCond1 = "1=1 and questionsTypeId='02' and paperId='" + $("#hidPaperId").val() + "'";
    const strWhereCond = `1=1 and questionsTypeId='${Question_QA.questionTypeId}' and paperId='${clsPrivateSessionStorage.paperId}' order by orderNum Asc`;
    ...
    try {
      ...
      const hidQuestionsId = Question_QA.questionsId;
      if (hidQuestionsId != '') {
  ...
  public static async btnShowAnswer_Click(
    ...
    try {
      Question_QA.questionsId = strQuestionsId;
      // 使用动态导入加载函数代码块
      const { CommQuestionAnswer } = await import('../InteractManage/CommQuestionAnswer');
      // console.error('CommQuestionAnswer');
      Question_QA.questionsId = strQuestionsId;
  ...
  public async btnShowDiscuss_Click(strCommentOrder: enumCommentOrder) {
    ...
    const strUserId = userStore.getUserId;
    const strQuestionsId = Question_QA.questionsId;
    ...
    try {
      ...
      strWhereCond5 = ` answerTypeId='02' and questionsId='${strQuestionsId}' and topicId<>'00000000' `;
  ...
  public async btnShowGroupDiscuss_Click(strCommentOrder: enumCommentOrder) {
    if (Question_QA.questionsId == '') return;
    const divName = this.getDivName(enumDivType.LayOut_01);
    //绑定答案数据
    let arrvqa_AnswerObjLst1: Array<clsvqa_AnswerEN> = [];
    //strIdCurrEduclsarrvqa_AnswerObjLst1_1: Array<clsvqa_AnswerEN> = [];
  ...
  public async btnShowRecommendAnswer_Click(strCommentOrder: enumCommentOrder) {
    ...
    try {
      ...
      if (arrvqa_AnswerObjLst1.length == 0) {
        ...
        const objQuestions = await qa_Questions_GetObjByQuestionsIdAsync(Question_QA.questionsId);
        if (objQuestions == null) {
      ...
      for (let i = 0; i < arrvqa_AnswerObjLst1.length; i++) {
        ...
        if (objvQa_Answer.isSubmit == true) {
              ...
              if (objLike == null) {
                ...
                (function (strAnswerId, strUpdUser) {
                  spnReply_operate_item.onclick = function () {
                    Question_QA.vuebtn_Click('AddVote', `${strAnswerId}|${strUpdUser}`);
                  };
                ...
                strhtml += `<span class="reply-operate-item reply-operate-report J_ReplyReport" onclick=btnDelAnswer_Click("${arrvqa_AnswerObjLst3[j].answerId}")>删除</span>`;
                {
                  ...
                  (function (strAnswerId: string) {
                    spnReply_operate_item2.onclick = function () {
                      Question_QA.vuebtn_Click('DelAnswer', strAnswerId);
                    };
          ...
          if (objLike == null) {
            ...
            (function (strAnswerId: string) {
              spnComment_Operate_item.onclick = function () {
                Question_QA.vuebtn_Click('AddVote', strAnswerId);
              };
          ...
          strhtml += `<span class="J_Reply comment-operate-item comment-operate-reply" id="J_Reply" onclick=btnReplyAnswer_Click("${objvQa_Answer.answerId}")>回复</span>`;
          {
            ...
            (function (strAnswerId: string) {
              spnComment_Operate_item2.onclick = function () {
                Question_QA.vuebtn_Click('ReplyAnswer', strAnswerId);
              };
            })(objvQa_Answer.answerId);
          ...
          strhtml += `<div class="J_Report comment-report" style="right:150px;" onclick=SearchParentV("${objvQa_Answer.answerId}")>历史版本</div>`;
          {
            ...
            divSearchParentV.innerHTML = '历史版本1';
            divSearchParentV.style.right = '150px';
            (function (strAnswerId: string) {
              divSearchParentV.onclick = function () {
                Question_QA.vuebtn_Click('SearchParentV', strAnswerId);
              };
            })(objvQa_Answer.answerId);
                ...
                strhtml += `<div class="J_Report comment-report" style="right:100px;" id="J_Report6673850347411436155" onclick=btnSubmitQa_Answer_Click("${objvQa_Answer.answerId}")>提交</div>`;
                {
                  ...
                  (function (strAnswerId: string) {
                    divSubmit.onclick = function () {
                      Question_QA.vuebtn_Click('SubmitQa_Answer', strAnswerId);
                    };
                  })(objvQa_Answer.answerId);
                ...
                strhtml += `<div class="J_Report comment-report" style="right:50px;" id="J_Report6673850347411436155" onclick=btnUpdateQa_Answer_Click("${objvQa_Answer.answerId}","${objvQa_Answer.topicId}")>修改</div>`;
                {
                  ...
                  (function (strAnswerId, strTopicId) {
                    divUpdate.onclick = function () {
                      Question_QA.vuebtn_Click('UpdateQa_Answer', `${strAnswerId}|${strTopicId}`);
                    };
                  })(objvQa_Answer.answerId, objvQa_Answer.topicId);
  ...
  public async AddNewqa_Push() {
    try {
      ...
      for (let i = 0; i < arrCurrEduClsStuObjLst.length; i++) {
        ...
        objqa_PushEN.SetQuestionsId(Question_QA.questionsId);
  ...
  */
  public PutDataToqa_AnswerVClass(pobjqa_AnswerVerEN: clsqa_AnswerVerEN) {
    // const divName = this.getDivName(enumDivType.LayOut_01);
    const strUserId = userStore.getUserId;
    pobjqa_AnswerVerEN.SetQuestionsId(Question_QA.questionsId); //问题ID
    ...
    pobjqa_AnswerVerEN.SetAnswerTypeId(Question_QA.answerTypeId); //回答类型Id
    pobjqa_AnswerVerEN.SetParentId(Question_QA.parentId); //父节点
  ...
  */
  ...
  public async DiscussSubmit_Click() {
    ...
    const objqa_AnswerEN: clsqa_AnswerEN = new clsqa_AnswerEN();
    if (Question_QA.parentId == '') Question_QA.parentId = 'root';
    const strDiscussContent = GetTextAreaValueInDivObj(divName, 'txtDiscussContent');
    if (strDiscussContent == '') {
      message.warning('请输入发布内容！');
      return;
    }
    objqa_AnswerEN.SetQuestionsId(Question_QA.questionsId); //问题ID
    let strTopicId = clsPrivateSessionStorage.topicIdInTree;
    if (strTopicId == '') strTopicId = '00000000';
    objqa_AnswerEN.SetTopicId(strTopicId);
    objqa_AnswerEN.SetAnswerTypeId(Question_QA.answerTypeId); //回答类型Id
    objqa_AnswerEN.SetParentId(Question_QA.parentId); //父节点
    ...
    try {
      ...
      if (strAnswerId != '') {
        //if (returnBool == true) {
        Question_QA.answerContent = strDiscussContent;
        const [strQuestionId, strAnswerTypeId] =
          await qa_AnswerEx_GetQuestionIdAnswerTypeIdByAnswerIdAsyncEx(strAnswerId);
        await this.SynAnswer(strQuestionId, strAnswerTypeId);
 ...
 */
  ...
  */
  ...
  public PutDataToqa_AnswerClass(pobjqa_AnswerEN: clsqa_AnswerEN) {
    const divName = this.getDivName(enumDivType.LayOut_01);
    pobjqa_AnswerEN.SetQuestionsId(Question_QA.questionsId); //问题ID
    if (GetInputValueInDivObj(divName, 'hidIsRecommend') != '') {
    ...
    //pobjqa_AnswerEN.SetParentId("root";//父节点
    pobjqa_AnswerEN.SetAnswerTypeId(Question_QA.answerTypeId); //回答类型Id
    pobjqa_AnswerEN.SetParentId(Question_QA.parentId); //父节点
    pobjqa_AnswerEN.SetIdCurrEduCls(clsPubLocalStorage.idCurrEduCls); //教学班Id
  ...
  */
  ...
  public async PutDataTogs_AnswerCountClass(pobjgs_AnswerCountEN: clsgs_AnswerCountEN) {
    ...
    pobjgs_AnswerCountEN.SetQuestionsId(Question_QA.questionsId); //问题ID
    if (GetInputValueInDivObj(divName, 'hidIsRecommend') != '') {
    ...
    pobjgs_AnswerCountEN.SetAnswerTypeId(Question_QA.answerTypeId); //回答类型Id
    //pobjgs_AnswerCountEN.SetParentId($("#hidParentId").val();//父节点

    pobjgs_AnswerCountEN.SetAnswerContent(Question_QA.answerContent); // 答案内容
  ...
  public async btnAddVote_Click(strAnswerId: string, strUserId: string) {
    ...
    objSysVoteEN.SetPubParentId(Question_QA.questionsId);
...
*/
  ...
  public async SearchParentV(strAnswerId: string) {
    try {
      ...
      // console.error('CommQuestionAnswer');
      // 调用加载的函数
      CommQuestionAnswer.divLayout = Question_QA.divLayout;
      const objPage = new CommQuestionAnswer();
      // const objLayOut = objPage.getDivName(enumDivType.LayOut_01);
      // if (objLayOut == null) return;
