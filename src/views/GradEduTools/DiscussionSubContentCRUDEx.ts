...
export class DiscussionSubContentCRUDEx extends DiscussionSubContentCRUD implements IShowList {
  ...
  BindGv(strType: string, strPara: string) {
    ...
    this.BindGv_vDiscussionSubContent(this.thisDivList);
  }
  BindGvCache(strType: string, strPara: string) {
    ...
    switch (strType) {
      case 'vDiscussionSubContent':
        ...
        //this.BindGv_vDiscussionSubContentCache();;
        break;
      default:
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    ...
    if (DiscussionSubContentCRUD.objPageCRUD == null) {
      DiscussionSubContentCRUD.objPageCRUD = new DiscussionSubContentCRUDEx(divLayout);
      objPage = <DiscussionSubContentCRUDEx>DiscussionSubContentCRUD.objPageCRUD;
    } else {
      objPage = <DiscussionSubContentCRUDEx>DiscussionSubContentCRUD.objPageCRUD;
    }
    ...
    switch (strCommandName) {
      ...
      case 'ReOrder': //重序记录
        ...
        break;
      default:
        AccessBtnClickDefault(strCommandName, 'DiscussionSubContentCRUDExEx.btn_Click');
