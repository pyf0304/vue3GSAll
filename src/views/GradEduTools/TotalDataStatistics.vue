          ...
          <tr>
            ...
            <td id="td_IsRecommend">
              <span class="form-control" style="width: 120px">
                <input
                  ...
                  name="chkIsRecommend"
                  Text="是否推荐"
                /><label for="chkIsRecommend">是否推荐</label>
              </span>
            </td>
            <td>
              <button
            ...
            <td>
              <button
                class="btn btn-primary"
                style="width: 170px"
                id="btnSynAnswerCount"
                name="btnDelRecord"
                @click="btnSynAnswerCount_Click()"
                ><i class="layui-icon">&#xe605;</i>同步讨论回答统计</button
              >
            </td>
            <td>
              <button
                ...
                ><i class="layui-icon">&#xe605;</i>转化Canvas图片</button
              >
              <button
                class="btn btn-primary"
                style="width: 170px; display: none"
                id="btnExportWord"
                name="btnExportWord"
                ><i class="layui-icon">&#xe605;</i>导出Canvas图片</button
              >
            </td>
          </tr>
        </table>
              ...
              <div>
                <div class="btn-group">
                  ...
                  <button
                    ...
                    name="btnDelRecord"
                    @click="liTeaClassAverage_Click()"
                    ><i class="layui-icon">&#xe67a;</i>教学班周均分趋势图</button
                  >
                  <button
                    class="btn btn-success"
                    id="btnTeaClassComment"
                    name="btnDelRecord"
                    @click="liTeaClassComment_Click()"
                    ><i class="layui-icon">&#xe66c;</i>教学班周评论数统计图</button
                  >
                  <button
                    class="btn btn-danger"
                    id="btnUserCommentNum"
                    name="btnDelRecord"
                    @click="liUserCommentNum_Click()"
                    ><i class="layui-icon">&#xe613;</i>用户周评论数统计图</button
                  >
                  <button
                    class="btn btn-warning"
                    id="btnUserDiscussNum"
                    name="btnDelRecord"
                    @click="liUserDiscussNum_Click()"
                    ><i class="layui-icon">&#xe613;</i>用户周讨论回答统计图</button
                  >
                </div>
              </div>
              <div>
                  ...
                  <div style="width: 99%; padding: 15px">
                    <div style="height: 380px; border: 1px solid #e6e6e6; background-color: #fff">
                      <div class="panel panel-default">
                        ...
                        <div id="div_Canvas5" class="panel-body"> </div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div style="width: 99%; padding: 15px">
                    <div style="height: 650px; border: 1px solid #e6e6e6; background-color: #fff">
                      <div class="panel panel-default">
                        ...
                        <div id="div_Canvas6" class="panel-body"> </div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div style="width: 99%; padding: 15px">
                    <div style="height: 650px; border: 1px solid #e6e6e6; background-color: #fff">
                      <div class="panel panel-default">
                        ...
                        <div id="div_Canvas7" class="panel-body"> </div>
                      </div>
                    </div>
                  </div>
                  <div class="layui-card-body">
...
<script lang="ts">
  ...
  */
      ...
      function AllAreaWordTwo(cont: any, key: any) {
      ...
      //教学班评论统计
      function Canvas5(strlabelsJson: string, strdatasetsJson: string, strColorJson: string) {
        var config = {
          type: 'bar',
          data: {
            labels: strlabelsJson,
        ...
        $('#div_Canvas5').html(
          '<canvas id="Canvas5" style="height: 320px; width: 100%;"></canvas>',
        );
      ...
      var customTooltips6 = function (tooltip: any) {
        // Tooltip Element
      ...
      //所有学生各观点统计
      function Canvas6(strlabelsJson: string, strdatasetsJson: string) {
        var config = {
          type: 'line',
          data: {
            labels: strlabelsJson,
        ...
        //$('#Canvas3').remove();
        $('#div_Canvas6').html(
          '<canvas id="Canvas6" style="height: 550px; width: 100%; padding-right: 10px;"></canvas>',
        );
      ...
      //所有学生各观点统计
      function Canvas7(strlabelsJson: string, strdatasetsJson: string) {
        var config = {
          type: 'line',
          data: {
            labels: strlabelsJson,
        ...
        //$('#Canvas3').remove();
        $('#div_Canvas7').html(
          '<canvas id="Canvas7" style="height: 500px; width: 100%; padding-right: 10px;"></canvas>',
        );
  ...
  */
        ...
        if (strCommandName == '') {
          var strKeyId = GetInputValueInDivObj(refDivLayout.value, 'hidgs_DateId');

          if (strKeyId == '') {
            gs_TeachingDateCRUDEx.btn_Click('Create', strKeyId, refDivLayout.value);
          } else {
            gs_TeachingDateCRUDEx.btn_Click('UpdateRecordInTab', strKeyId, refDivLayout.value);
          }
        }
      ...
      return {
        ...
        liTeaClassAverage_Click,
        liTeaClassComment_Click,
        location_reload,
        btnSynTotalDataStatistics_Click,
        btnSetUpDateRecord_Click,
        btnSynAnswerCount_Click,
        btnExportWord_Click,
        liUserCommentNum_Click,
        liUserDiscussNum_Click,
      };
    },
