    ...
    <div id="divDetailLayout" ref="refDivDetail" class="tab_layout">
      ...
      >
        <tr>
          <td class="text-right">
            <span
              id="spnClassificationName_d"
              name="spnClassificationName_d"
          ...
          <td class="text-left">
            <label
              id="lblClassificationName_d"
              name="lblClassificationName_d"
              class="text-primary"
              style="width: 150px"
            >
            </label>
...
<script lang="ts">
  ...
  import { gs_VpClassification_DetailEx } from '@/views/GradEduTopic/gs_VpClassification_DetailEx';
  export default defineComponent({
    name: 'GsVpClassificationDetail',
    components: {
      // 组件注册
    },
    setup() {
      const strTitle = ref('各观点分类表详细信息');
    ...
    methods: {
       ...
       **/
      btngs_VpClassification_Detail_Click(strCommandName: string, strKeyId: string) {
        gs_VpClassification_DetailEx.btnDetail_Click(strCommandName, strKeyId);
      },
    },
  });
</script>
