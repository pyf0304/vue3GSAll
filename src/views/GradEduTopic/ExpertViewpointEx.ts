...
import { ExpertViewpoint } from './ExpertViewpoint';
  ...
  public async PageLoad() {
    ...
    try {
      ...
      if (strUserId != '') {
        ...
        await clsDropDownList.BindDdl_UserIdInvExpertviewpoint_Cache('ddlViewPointUserId_q'); // this.BindDdl_UserId("ddlUserId_q");
  ...
  */
  public async btnAddNewRecord_Click() {
    ...
    try {
      ...
      //获取分享Id
      const responseText1 = await gs_UserConfigEx_GetNewReturnShareIdEx('05', userStore.getUserId);
...
*/
  ...
  //          return;
  //      }
  //      const objgs_Share_Cond: clsgs_ShareEN = new clsgs_ShareEN();//编辑区域
