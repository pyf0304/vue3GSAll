  ...
  <div id="divLayout" ref="refDivLayout" class="divComContainer">
    ...
    <div id="divQuery" ref="refDivQuery" class="div_query">
      ...
      >
        <tr>
          <td class="text-right">
            <label
              id="lblProblemTitle_q"
              name="lblProblemTitle_q"
    ...
    <div id="divFunction" ref="refDivFunction" class="table table-bordered table-hover">
      <ul class="nav">
        <li class="nav-item">
          <label
            id="lblgs_TobeStudiedProblemList"
            name="lblgs_TobeStudiedProblemList"
    ...
    <div id="divList" ref="refDivList" class="div_List">
      ...
      <input id="hidSortvgs_TobeStudiedProblemBy" type="hidden" />
    </div>
    <!--编辑层-->
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'GsTobeStudiedProblemCRUD',
    components: {
      // 组件注册
      gs_TobeStudiedProblem_EditCom,
    },
    setup() {
      const strTitle = ref('待研究问题维护');
      ...
      onMounted(() => {
        const objPage = new gs_TobeStudiedProblemCRUDEx(refDivLayout.value);
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        switch (strCommandName) {
          ...
          case 'UpdateRecordInTab':
            gs_TobeStudiedProblemCRUD.EditObj = gs_TobeStudiedProblem_EditRef.value;
            gs_TobeStudiedProblem_Edit.EditObj = gs_TobeStudiedProblem_EditRef.value;
            break;
          default:
            break;
        }
        gs_TobeStudiedProblemCRUDEx.btn_Click(strCommandName, strKeyId, refDivLayout.value);
      }
      return {
        strTitle,
        btn_Click,
