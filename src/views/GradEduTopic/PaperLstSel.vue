<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
    ...
    <div id="divLayout_PaperSel" ref="refDivLayout" class="tab_layout">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const showDialog = () => {
        return new Promise((resolve) => {
          ...
          resolve('对话框打开成功');
          PaperLstSel.vuebtn_Click = btn_Click;
          PaperLstSel.GetPropValue = GetPropValue;
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        //}
        PaperLstSel.btn_Click(strCommandName, strKeyId, refDivLayout.value);
      }
      return {
        strTitle,
        dialogVisible,
    ...
    methods: {
      ...
      btnSysSocialRelations_Edit_Click(strCommandName: string, strKeyId: string) {
        PaperLstSel.btnEdit_Click(strCommandName, strKeyId);
      },
    },
  });
</script>
