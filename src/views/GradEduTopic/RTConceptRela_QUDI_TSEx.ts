...
import {
  vRTConceptRela_GetObjLstByPagerAsync,
  vRTConceptRela_GetRecCountByCondAsync,
...
export class RTConceptRela_QUDI_TSEx extends RTConceptRelaCRUD {
  ...
  public async PageLoad() {
    ...
    try {
      ...
      await vRTConceptRela_GetRecCountByCondAsync(strWhereCond).then((jsonData) => {
      ...
      await this.BindGv_vRTConceptRela(this.thisDivList);
    } catch (e: any) {
 ...
 */
  public async CombinevRTConceptRelaCondition(): Promise<string> {
    ...
    try {
      ...
      const strMsg = `(errid:WiTsCs0002)在组合查询条件(CombineRTConceptRelaCondition)时出错!请联系管理员!${objException}`;
      throw strMsg;
    }
    return strWhereCond;
  }
  ...
  */
  public async BindGv_vRTConceptRela(divList: HTMLDivElement) {
    const objLayOut = this.getDivName(enumDivType.LayOut_01);
    if (objLayOut == null) return;
    ...
    try {
      ...
      arrvRTConceptRelaObjLst = await vRTConceptRela_GetObjLstByPagerAsync(objPagerPara);
    } catch (e: any) {
    ...
    try {
      this.BindTab_vRTConceptRela(divList, arrvRTConceptRelaObjLst);
 ...
 */
  public async BindTab_vRTConceptRela(
    ...
    BindTab_V(divDataLst, arrvRTConceptRelaObjLst, arrDataColumn, 'mId', this);
