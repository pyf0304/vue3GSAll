...
//得到3个关系列表数据；
export async function gs_TopicRoleCRUDExB_TopicMenuIsHide() {
...
*/
export class gs_TopicRoleCRUDExB extends gs_TopicRoleCRUD implements IShowList {
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    const objPage: gs_TopicRoleCRUDExB = new gs_TopicRoleCRUDExB();
