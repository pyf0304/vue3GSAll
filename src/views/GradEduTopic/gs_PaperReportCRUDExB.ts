...
// declare function layui_Alert(str1: string, str2: string): void;

/* gs_PaperReportCRUDEx 的摘要说明。其中Q代表查询,U代表修改
 (AutoGCLib.WA_ViewScriptCSEx_TS4TypeScript:GeneCode)
*/
export class gs_PaperReportCRUDExB extends gs_PaperReportCRUD implements IShowList {
...
export function gs_PaperReportCRUDExB_btn_Click(strCommandName: string, strKeyId: string) {
