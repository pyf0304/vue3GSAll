import { RTSysSkillRela_EditEx } from './RTSysSkillRela_EditEx';
...
export class RTSysSkillRelaCRUDEx extends RTSysSkillRelaCRUD implements IShowList {
  ...
  BindGv(strType: string, strPara: string) {
    ...
    this.BindGv_vRTSysSkillRelaCache(this.thisDivList);
  }
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    ...
    let objPageEdit;
    if (RTSysSkillRelaCRUD.objPageCRUD == null) {
      RTSysSkillRelaCRUD.objPageCRUD = new RTSysSkillRelaCRUDEx(divLayout);
      objPage = <RTSysSkillRelaCRUDEx>RTSysSkillRelaCRUD.objPageCRUD;
    } else {
      objPage = <RTSysSkillRelaCRUDEx>RTSysSkillRelaCRUD.objPageCRUD;
    }
    ...
    switch (strCommandName) {
      ...
      case 'Update': //修改记录
        ...
        objPageEdit = new RTSysSkillRela_EditEx('RTSysSkillRela_EditEx', objPage);
