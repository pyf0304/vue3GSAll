import { gs_UserConfig_EditEx } from './gs_UserConfig_EditEx';
...
export class gs_UserConfigCRUDEx extends gs_UserConfigCRUD implements IShowList {
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    ...
    const objPageEdit: gs_UserConfig_EditEx = new gs_UserConfig_EditEx(
      'gs_UserConfig_EditEx',
      objPage,
    );
    ...
    switch (strCommandName) {
      ...
      case 'ReOrder': //重序记录
        ...
        break;
      default:
        AccessBtnClickDefault(strCommandName, 'gs_UserConfigCRUDExEx.btn_Click');
