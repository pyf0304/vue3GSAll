import { RTPaperRela_EditEx } from '../GradEduTopic/RTPaperRela_EditEx';
...
export class RTPaperRelaCRUDEx extends RTPaperRelaCRUD implements IShowList {
  ...
  BindGv(strType: string, strPara: string) {
    ...
    this.BindGv_vRTPaperRelaCache(this.thisDivList);
  }
  ...
  public static btn_Click(strCommandName: string, strKeyId: string, divLayout: HTMLDivElement) {
    ...
    if (RTPaperRelaCRUD.objPageCRUD == null) {
      RTPaperRelaCRUD.objPageCRUD = new RTPaperRelaCRUDEx(divLayout);
      objPage = <RTPaperRelaCRUDEx>RTPaperRelaCRUD.objPageCRUD;
    } else {
      objPage = <RTPaperRelaCRUDEx>RTPaperRelaCRUD.objPageCRUD;
    }
    const objPageEdit: RTPaperRela_EditEx = new RTPaperRela_EditEx('RTPaperRela_EditEx', objPage);
