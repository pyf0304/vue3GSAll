...
export class Paper_ListEx_Direction extends PaperCRUD {
  ...
  */
  public async PageLoad() {
    ...
    try {
      ...
      if (userStore.getUserId != '') {
        ...
        await this.BindGv_PaperDirection(this.thisDivList);
  ...
  //绑定本方向
  public async BindGv_PaperDirection(divList: HTMLDivElement) {
    const objLayOut = this.getDivName(enumDivType.LayOut_01);
    if (objLayOut == null) return;
    ...
    const strMajorDirectionId = clsPubLocalStorage.majorDirectionId;
    ...
    try {
      ...
      await PaperEx_BindList_Paper('3', divList, arrPaperExObjLst, this.divLayout);
 ...
 */
    ...
    try {
      ...
      if (returnBool == true) {
        ...
        if (returnBool == true) {
          ...
          this.BindGv_PaperDirection(this.thisDivList);
        } else {
  ...
  public get thisDivList(): HTMLDivElement {
    ...
    const divList = GetDivObjInDivObj(divLayOut, 'divList_Direction');
    return divList;
  }
}
