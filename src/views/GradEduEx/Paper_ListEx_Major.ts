...
export class Paper_ListEx_Major extends PaperCRUD {
  ...
  public async PageLoad() {
    ...
    try {
      ...
      if (userStore.getUserId != '') {
        ...
        await this.BindGv_PaperMajor(this.thisDivList);
  ...
  */
  ...
  public async BindGv_PaperMajor(divList: HTMLDivElement) {
    const objLayOut = this.getDivName(enumDivType.LayOut_01);
    if (objLayOut == null) return;
    ...
    try {
      ...
      await PaperEx_BindList_Paper('2', divList, arrPaperExObjLst, this.divLayout);
    ...
    try {
      ...
      if (returnBool == true) {
        ...
        if (returnBool == true) {
          ...
          this.BindGv_PaperMajor(this.thisDivList);
        } else {
