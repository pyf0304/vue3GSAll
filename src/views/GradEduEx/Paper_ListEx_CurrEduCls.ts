...
export class Paper_ListEx_CurrEduCls extends PaperCRUD {
  ...
  public async PageLoad() {
    ...
    try {
      ...
      if (userStore.getUserId != '') {
        ...
        await this.BindGv_PaperEduCls(this.thisDivList);
  ...
  */
  ...
  //绑定本专业
  public async BindGv_PaperEduCls(divList: HTMLDivElement) {
    const objLayOut = this.getDivName(enumDivType.LayOut_01);
    if (objLayOut == null) return;
    ...
    try {
      ...
      await PaperEx_BindList_Paper('2', divList, arrPaperExObjLst, objLayOut);
    ...
    try {
      ...
      if (returnBool == true) {
        ...
        if (returnBool == true) {
          ...
          this.BindGv_PaperEduCls(this.thisDivList);
        } else {
