...
*/
  public async BindGv_vRTViewpointRela(divList: HTMLDivElement) {
    ...
    const strWhereCond = await this.CombinevRTViewpointRelaCondition1();
    ...
    try {
      this.BindTab_vRTViewpointRela(divList, arrvRTViewpointRelaObjLst1);
...
*/
  public async BindTab_vRTViewpointRela(
    ...
    arrvRTViewpointRelaObjLst1: Array<clsvRTViewpointRelaEN>,
  ) {
    ...
    BindTab_V(divDataLst, arrvRTViewpointRelaObjLst1, arrDataColumn, 'mId', this);
