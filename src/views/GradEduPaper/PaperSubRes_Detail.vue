    ...
    <div id="divDetailLayout" ref="refDivDetail" class="tab_layout">
      ...
      >
        <tr>
          <td class="text-right">
            <span
              id="spnPaperSubResName_d"
              name="spnPaperSubResName_d"
          ...
          <td class="text-left">
            <label
              id="lblPaperSubResName_d"
              name="lblPaperSubResName_d"
              class="text-primary"
              style="width: 150px"
            >
            </label>
...
<script lang="ts">
  ...
  import { PaperSubRes_DetailEx } from '@/views/GradEduPaper/PaperSubRes_DetailEx';
  export default defineComponent({
    name: 'PaperSubResDetail',
    components: {
      // 组件注册
    },
    setup() {
      const strTitle = ref('论文子资源详细信息');
    ...
    methods: {
       ...
       **/
      btnPaperSubRes_Detail_Click(strCommandName: string, strKeyId: string) {
        PaperSubRes_DetailEx.btnDetail_Click(strCommandName, strKeyId, this.refDivDetail);
      },
    },
  });
</script>
