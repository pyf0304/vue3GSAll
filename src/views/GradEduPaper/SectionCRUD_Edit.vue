<template>
    ...
    <div id="divLayout" ref="refDivLayout" class="divComContainer">
      ...
      <div id="divList" ref="refDivList" class="div_List">
        ...
        <input id="hidSortvSectionBy" type="hidden" />
      </div>
      <!--编辑层-->
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(() => {
        const objPage = new SectionCRUD_EditEx(refDivLayout.value);
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        SectionCRUD_EditEx.btn_Click(strCommandName, strKeyId, refDivLayout.value);
      }
