<template>
  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
        ...
        <tr id="trSchoolTerm">
          ...
          <td class="text-left">
            <select
              ...
              name="ddlIdPk2EduClsTeacherType"
              class="form-control form-control-sm"
              style="width: 150px"
            ></select>
          </td>
    ...
    <template #footer>
      ...
      <el-button
        id="btnSubmitCurrEduClsTeacher"
        type="primary"
        @click="btnCurrEduClsTeacher_Edit_Click('Submit', '')"
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const SetButtonText = (strButtonId: string, strNewValue: string) => {
        let strMsg;
        switch (strButtonId) {
          case 'btnCancelCurrEduClsTeacher':
            strCancelButtonText.value = strNewValue;
            break;
          case 'btnSubmitCurrEduClsTeacher':
    ...
    methods: {
      ...
      btnClick(strCommandName: string, strKeyId: string) {
        ...
        //}
        //CurrEduClsTeacher_Edit.btnClick(strCommandName, strKeyId);
      },
       ...
       **/
      Submit_CurrEduClsTeacher(strOp: string) {
        alert(`提交${strOp}`);
        const objPage = new CurrEduClsTeacher_EditEx('', new CurrEduClsTeacherCRUDEx());
