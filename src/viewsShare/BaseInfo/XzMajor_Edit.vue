  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const SetButtonText = (strButtonId: string, strNewValue: string) => {
        let strMsg;
        switch (strButtonId) {
          case 'btnCancelXzMajor':
            strCancelButtonText.value = strNewValue;
            break;
          case 'btnSubmitXzMajor':
    ...
    methods: {
      ...
      btnClick(strCommandName: string, strKeyId: string) {
        ...
        //}
        //XzMajor_Edit.btnClick(strCommandName, strKeyId);
      },
       ...
       **/
      Submit_XzMajor(strOp: string) {
        alert(`提交${strOp}`);
        const objPage = new XzMajor_EditEx('', new XzMajorCRUDEx());
