  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const SetButtonText = (strButtonId: string, strNewValue: string) => {
        let strMsg;
        switch (strButtonId) {
          case 'btnCancelKnowledgeType':
            strCancelButtonText.value = strNewValue;
            break;
          case 'btnSubmitKnowledgeType':
    ...
    methods: {
      ...
      btnClick(strCommandName: string, strKeyId: string) {
        ...
        //}
        //KnowledgeType_Edit.btnClick(strCommandName, strKeyId);
      },
       ...
       **/
      Submit_KnowledgeType(strOp: string) {
        alert(`提交${strOp}`);
        const objPage = new KnowledgeType_EditEx('', new KnowledgeTypeCRUDEx());
