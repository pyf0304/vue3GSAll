  ...
  <el-dialog v-model="dialogVisible" :width="dialogWidth" :show-close="false">
    ...
    <div id="divDetailLayout" ref="refDivDetail" class="tab_layout">
      ...
      >
        <tr>
          <td class="text-right">
            <span id="spnMyRoleId_d" name="spnMyRoleId_d" CssClass="col-form-label text-right"
              >主角色Id</span
            >
          </td>
          <td class="text-left">
        ...
        <tr>
          ...
          <td class="text-left">
            <label id="lblQxPrjId_d" name="lblQxPrjId_d" class="text-primary" style="width: 150px">
            </label>
          </td>
          <td class="text-right">
            <span id="spnMyRoleName_d" name="spnMyRoleName_d" CssClass="col-form-label text-right"
              >主角色名</span
            >
          </td>
          <td class="text-left">
            <label id="lblMyRoleName_d" name="lblMyRoleName_d" class="text-primary"> </label>
          </td>
        </tr>
        <tr>
          <td class="text-right">
          ...
          <td class="text-left">
            <label id="lblRoleName_d" name="lblRoleName_d" class="text-primary"> </label>
          </td>
          <td class="text-right">
          ...
          <td class="text-left">
            <label id="lblPrjName_d" name="lblPrjName_d" class="text-primary"> </label>
          </td>
        </tr>
        <tr>
          <td class="text-right">
...
<script lang="ts">
  ...
  import { QxRoleRightRelation_DetailEx } from '@/viewsShare/UserManage/QxRoleRightRelation_DetailEx';
  export default defineComponent({
    name: 'QxRoleRightRelationDetail',
    components: {
      // 组件注册
    },
    setup() {
      const strTitle = ref('角色赋权关系详细信息');
    ...
    methods: {
       ...
       **/
      btnQxRoleRightRelation_Detail_Click(strCommandName: string, strKeyId: string) {
        QxRoleRightRelation_DetailEx.btnDetail_Click(strCommandName, strKeyId);
      },
    },
  });
</script>
