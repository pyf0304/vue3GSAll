...
import { vCurrEduCls_GetObjLstAsync,vCurrEduCls_SortFunByKey,vCurrEduCls_FilterFunByKey } from "@/ts/L3ForWApi/DailyRunning/clsvCurrEduClsWApi";
...
const arrvCurrEduClsExObjLst = arrvCurrEduClsObjLst.map(vCurrEduClsEx_CopyToEx);
 ...
 if (IsNullOrEmpty(objSortInfo.SortFld) == false && clsvCurrEduClsEN.AttributeName.indexOf(objSortInfo.SortFld) == -1)
 {
...
arrvCurrEduClsSel = arrvCurrEduClsSel.slice(intStart, intEnd);     
