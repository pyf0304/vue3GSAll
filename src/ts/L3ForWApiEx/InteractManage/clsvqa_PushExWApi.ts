...
import {
  ...
  vqa_Push_SortFunByKey,
  vqa_Push_FilterFunByKey,
 ...
 * @returns 对象列表
 */
export async function vqa_PushEx_GetObjExLstByPagerAsync(
  objPagerPara: stuPagerPara,
): Promise<Array<clsvqa_PushENEx>> {
  ...
  if (IsNullOrEmpty(objSortInfo.SortFld) == false) {
    for (const objInFor of arrvqa_PushExObjLst) {
      await vqa_PushEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
    }
  }
