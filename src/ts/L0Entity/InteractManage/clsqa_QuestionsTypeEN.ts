...
public static AttributeName = ["questionsTypeId", "questionsTypeName", "questionsTypeEnName", "memo"];
//以下是属性变量
...
private mstrQuestionsTypeEnName = "";    //问题类型英文名
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetQuestionsTypeEnName (value: string)
{
if (value  != undefined)
{
 this.questionsTypeEnName = value;
    this.hmProperty["questionsTypeEnName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
return this.questionsTypeEnName;
...
break;
case clsqa_QuestionsTypeEN.con_QuestionsTypeEnName:
this.questionsTypeEnName = strValue;
    this.hmProperty["questionsTypeEnName"] = true;
break;
case clsqa_QuestionsTypeEN.con_Memo:
this.memo = strValue;
...
public questionsTypeEnName = "";    //问题类型英文名
public memo = "";    //备注
 ...
 * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 */
 public static get con_QuestionsTypeEnName(): string {return "questionsTypeEnName";}    //问题类型英文名
 ...
 * 教师提问
 **/
static readonly TeacherInquiry_02 = "02";
 /**
 * 测试提问
 **/
static readonly TestInquiry_03 = "03";
 /**
 * Zx生僻字词
 **/
static readonly UncommonWords_11 = "11";
 /**
 * Zx课文疑问
 **/
static readonly TextualQuestions_12 = "12";
 /**
 * Zx基本问题
 **/
static readonly FundamentalQuestions_15 = "15";
 /**
 * Zx理解推理
 **/
static readonly UnderstandingReasoning_16 = "16";
 /**
 * Zx观点依据
 **/
static readonly BasisOfOpinion_17 = "17";
 /**
 * Zx阅读自问
 **/
static readonly ReadingSelfQuestioning_18 = "18";
 /**
 * Zx故事结尾
 **/
static readonly StoryEnding_19 = "19";
 /**
 * Zx思维导图
 **/
static readonly MindMap_20 = "20";
 /**
 * Zx相关资源
 **/
static readonly RelatedResources_21 = "21";
}