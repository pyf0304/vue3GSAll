...
public static AttributeName = ["mId", "courseKnowledgeId", "courseKnowledgeTitle", "xPosition", "yPosition", "knowledgeGraphId", "nodeColor", "logicNodeId", "classNameCss", "courseId", "updDate", "updUser", "memo"];
//以下是属性变量
