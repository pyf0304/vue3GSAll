...
export class  clsTextDirectEN extends clsGeneralTab
{
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetTextDirectName (value: string)
{
if (value  != undefined)
{
 this.textDirectName = value;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[TextDirect]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
