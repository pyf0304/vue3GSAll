...
export class  clsPaperSubResEN extends clsGeneralTab
{
...
private mstrPaperSubResName = "";    //子资源名称
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetPaperSubResName (value: string)
{
if (value  != undefined)
{
 this.paperSubResName = value;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[PaperSubRes]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
