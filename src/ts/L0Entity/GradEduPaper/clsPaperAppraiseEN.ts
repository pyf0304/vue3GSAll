...
export class clsPaperAppraiseEN extends clsGeneralTab {
   ...
   */
  public static get con_PaperAppraiseId(): string {
    return 'paperAppraiseId';
  } //论文评论Id
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_PaperAppraiseContent(): string {
    return 'paperAppraiseContent';
  } //论文评论内容
