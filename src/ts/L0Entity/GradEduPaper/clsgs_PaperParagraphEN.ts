...
export class clsgs_PaperParagraphEN extends clsGeneralTab {
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_ParagraphStateId(): string {
    return 'paragraphStateId';
  } //段落状态Id
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_CommentCount(): string {
    return 'commentCount';
  } //评论数
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_VersionCount(): string {
    return 'versionCount';
  } //版本统计
   ...
   * (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
   */
  public static get con_CreateUser(): string {
    return 'createUser';
  } //建立用户
