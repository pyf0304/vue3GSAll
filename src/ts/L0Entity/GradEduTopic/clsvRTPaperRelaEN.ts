...
public static AttributeName = ["mId", "topicId", "paperId", "topicName", "topicContent", "topicProposePeople", "paperTitle", "paperContent", "author", "periodical", "isSubmit", "idCurrEduCls", "paperDate", "paperStatusId", "paperTypeId", "paperUserId", "versionCount", "paperTypeName", "updDate", "updUser", "memo"];
//以下是属性变量
