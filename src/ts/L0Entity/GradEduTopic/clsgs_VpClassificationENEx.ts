...
export class  clsgs_VpClassificationENEx extends clsgs_VpClassificationEN
{
//以下是属性变量
 ...
 */
 public static get con_TopicNames(): string {return "topicNames";}    //研究主题s
...
{
case clsgs_VpClassificationENEx.con_TopicNames:
this.topicNames = strValue;
    this.hmProperty["topicNames"] = true;
break;
case clsgs_VpClassificationENEx.con_DateTimeSim:
