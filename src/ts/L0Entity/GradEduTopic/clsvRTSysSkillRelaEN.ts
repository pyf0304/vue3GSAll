...
export class  clsvRTSysSkillRelaEN extends clsGeneralTabV
{
public static CacheAddiCondition = "";//缓存附加条件,作为向后台调取数据的附加条件
public static CacheModeId = "02"; //客户端缓存
public static IsUseDelSign = false; //使用删除标志,记录不能删除,仅设置删除标志
public static WhereFormat = ""; //条件格式串
public static _CurrTabName= "vRTSysSkillRela"; //当前表名,与该类相关的表名
public static _KeyFldName= "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static mintAttributeCount = 33;
public static AttributeName = ["topicName", "skillName", "operationTypeId", "process", "levelId", "levelName", "skillUpdUser", "skillUpdDate", "orderNum", "idCurrEduCls", "topicProposePeople", "topicContent", "isSubmit", "appraiseCount", "score", "stuScore", "teaScore", "pdfContent", "pdfPageNum", "citationCount", "versionCount", "operationTypeName", "okCount", "citationId", "mId", "topicId", "skillId", "updDate", "memo", "updUser", "createDate", "shareId", "classificationId"];
//以下是属性变量
...
default:
strMsg = `字段名:[${strFldName}]在表对象:[vRTSysSkillRela]中不存在!`;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[vRTSysSkillRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
