...
case "CtrlId":
return "";
case clsvSysSocialRelationsENEx.con_RelaUpdUser:
return this.relaUpdUser;
case clsvSysSocialRelationsENEx.con_RelaUpdDate:
return this.relaUpdDate;
case clsvSysSocialRelationsENEx.con_mId:
return this.mId;
default:
