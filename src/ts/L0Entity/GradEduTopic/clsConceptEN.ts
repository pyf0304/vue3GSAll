...
public static AttributeName = ["conceptId", "conceptName", "conceptContent", "isSubmit", "updDate", "memo", "citationId", "appraiseCount", "okCount", "score", "stuScore", "teaScore", "idCurrEduCls", "pdfContent", "pdfPageNum", "citationCount", "versionCount", "createDate", "shareId", "updUser"];
//以下是属性变量
