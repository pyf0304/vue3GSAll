...
public static AttributeName = ["mId", "topicId", "conceptId", "updDate", "memo", "topicName", "topicContent", "orderNum", "topicProposePeople", "conceptContent", "conceptName", "appraiseCount", "citationCount", "citationId", "isSubmit", "score", "stuScore", "teaScore", "concepDate", "concepUserId", "idCurrEduCls", "pdfContent", "pdfPageNum", "okCount", "versionCount", "createDate", "shareId", "updUser", "classificationId"];
//以下是属性变量
