 ...
 * @returns 返回两个对象比较的结果
*/
export  function vPaperCount2_SortFunDefa(a:clsvPaperCount2EN , b:clsvPaperCount2EN): number 
{
 ...
 * @returns 返回两个对象比较的结果
*/
export  function vPaperCount2_SortFunDefa2Fld(a:clsvPaperCount2EN , b:clsvPaperCount2EN): number 
{
...
//该表没有使用Cache,不需要生成[vPaperCount2__funcKey]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_funcKey)
 ...
 * @returns 返回的第一条记录的关键字值
*/
export  async function vPaperCount2_GetFirstID(strWhereCond: string) 
{
...
*/
export  function vPaperCount2_GetCombineCondition(objvPaperCount2Cond: clsvPaperCount2EN ):string
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_PaperId) == true)
{
const strComparisonOpPaperId:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_PaperId];
strWhereCond += Format(" And {0} {2} '{1}'", clsvPaperCount2EN.con_PaperId, objvPaperCount2Cond.paperId, strComparisonOpPaperId);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_Pcount) == true)
{
const strComparisonOpPcount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_Pcount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_Pcount, objvPaperCount2Cond.pcount, strComparisonOpPcount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_OkCount) == true)
{
const strComparisonOpOkCount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_OkCount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_OkCount, objvPaperCount2Cond.okCount, strComparisonOpOkCount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_AppraiseCount) == true)
{
const strComparisonOpAppraiseCount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_AppraiseCount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_AppraiseCount, objvPaperCount2Cond.appraiseCount, strComparisonOpAppraiseCount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_CollectionCount) == true)
{
const strComparisonOpCollectionCount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_CollectionCount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_CollectionCount, objvPaperCount2Cond.collectionCount, strComparisonOpCollectionCount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_DownloadCount) == true)
{
const strComparisonOpDownloadCount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_DownloadCount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_DownloadCount, objvPaperCount2Cond.downloadCount, strComparisonOpDownloadCount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_Score) == true)
{
const strComparisonOpScore:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_Score];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_Score, objvPaperCount2Cond.score, strComparisonOpScore);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_AttachmentCount) == true)
{
const strComparisonOpAttachmentCount:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_AttachmentCount];
strWhereCond += Format(" And {0} {2} {1}", clsvPaperCount2EN.con_AttachmentCount, objvPaperCount2Cond.attachmentCount, strComparisonOpAttachmentCount);
}
if (Object.prototype.hasOwnProperty.call(objvPaperCount2Cond.dicFldComparisonOp, clsvPaperCount2EN.con_UpdUser) == true)
{
const strComparisonOpUpdUser:string = objvPaperCount2Cond.dicFldComparisonOp[clsvPaperCount2EN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clsvPaperCount2EN.con_UpdUser, objvPaperCount2Cond.updUser, strComparisonOpUpdUser);
}
 return strWhereCond;
}
