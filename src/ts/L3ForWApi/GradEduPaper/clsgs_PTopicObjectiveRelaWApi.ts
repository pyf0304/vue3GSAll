 ...
 * @returns 返回两个对象比较的结果
*/
export  function gs_PTopicObjectiveRela_SortFunDefa(a:clsgs_PTopicObjectiveRelaEN , b:clsgs_PTopicObjectiveRelaEN): number 
{
return a.mId-b.mId;
}
/**
 ...
 * @returns 返回两个对象比较的结果
*/
export  function gs_PTopicObjectiveRela_SortFunDefa2Fld(a:clsgs_PTopicObjectiveRelaEN , b:clsgs_PTopicObjectiveRelaEN): number 
{
...
//该表没有使用Cache,不需要生成[gs_PTopicObjectiveRela__funcKey]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_funcKey)
 ...
 * @returns 返回的第一条记录的关键字值
*/
export  async function gs_PTopicObjectiveRela_GetFirstID(strWhereCond: string) 
{
...
try
{
const response = await axios.post(strUrl, objgs_PTopicObjectiveRelaEN, config);
const data = response.data;
if (data.errorId == 0)
{
...
*/
export  async function gs_PTopicObjectiveRela_GetMaxStrIdByPrefix(strPrefix: string) 
{
...
{
 throw new Error("(errid:Watl000411)字段[论文Id]不能为空(In 论文客观关系表)!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) === true )
{
 throw new Error("(errid:Watl000411)字段[客观Id]不能为空(In 论文客观关系表)!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
//检查字段长度, 若字符型字段长度超出规定的长度,即非法!
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.paperId) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.paperId) > 8)
{
 throw new Error("(errid:Watl000413)字段[论文Id(paperId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.paperId)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.sectionId) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.sectionId) > 8)
{
 throw new Error("(errid:Watl000413)字段[节Id(sectionId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.sectionId)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
...
{
 throw new Error("(errid:Watl000413)字段[客观Id(topicObjectiveId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updDate) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.updDate) > 20)
{
 throw new Error("(errid:Watl000413)字段[修改日期(updDate)]的长度不能超过20(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.updDate)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updUser) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.updUser) > 20)
{
 throw new Error("(errid:Watl000413)字段[修改人(updUser)]的长度不能超过20(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.updUser)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.memo) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.memo) > 1000)
{
 throw new Error("(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.memo)(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew)");
}
//检查字段的数据类型是否正确
...
{
 throw new Error("(errid:Watl000414)字段[mId(mId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.mId)], 非法,应该为数值型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[论文Id(paperId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.paperId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[节Id(sectionId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.sectionId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[客观Id(topicObjectiveId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[修改日期(updDate)]的值:[$(pobjgs_PTopicObjectiveRelaEN.updDate)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[修改人(updUser)]的值:[$(pobjgs_PTopicObjectiveRelaEN.updUser)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
{
 throw new Error("(errid:Watl000414)字段[备注(memo)]的值:[$(pobjgs_PTopicObjectiveRelaEN.memo)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckPropertyNew0)");
}
...
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.paperId) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.paperId) > 8)
{
 throw new Error("(errid:Watl000416)字段[论文Id(paperId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.paperId)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.sectionId) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.sectionId) > 8)
{
 throw new Error("(errid:Watl000416)字段[节Id(sectionId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.sectionId)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) > 8)
{
 throw new Error("(errid:Watl000416)字段[客观Id(topicObjectiveId)]的长度不能超过8(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updDate) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.updDate) > 20)
{
 throw new Error("(errid:Watl000416)字段[修改日期(updDate)]的长度不能超过20(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.updDate)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updUser) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.updUser) > 20)
{
 throw new Error("(errid:Watl000416)字段[修改人(updUser)]的长度不能超过20(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.updUser)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.memo) == false && GetStrLen(pobjgs_PTopicObjectiveRelaEN.memo) > 1000)
{
 throw new Error("(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 论文客观关系表(gs_PTopicObjectiveRela))!值:$(pobjgs_PTopicObjectiveRelaEN.memo)(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
//检查字段的数据类型是否正确
if (null != pobjgs_PTopicObjectiveRelaEN.mId && undefined !== pobjgs_PTopicObjectiveRelaEN.mId && tzDataType.isNumber(pobjgs_PTopicObjectiveRelaEN.mId) === false)
{
 throw new Error("(errid:Watl000417)字段[mId(mId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.mId)], 非法,应该为数值型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.paperId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.paperId && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.paperId) === false)
{
 throw new Error("(errid:Watl000417)字段[论文Id(paperId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.paperId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.sectionId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.sectionId && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.sectionId) === false)
{
 throw new Error("(errid:Watl000417)字段[节Id(sectionId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.sectionId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.topicObjectiveId && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId) === false)
{
 throw new Error("(errid:Watl000417)字段[客观Id(topicObjectiveId)]的值:[$(pobjgs_PTopicObjectiveRelaEN.topicObjectiveId)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updDate) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.updDate && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.updDate) === false)
{
 throw new Error("(errid:Watl000417)字段[修改日期(updDate)]的值:[$(pobjgs_PTopicObjectiveRelaEN.updDate)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.updUser) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.updUser && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.updUser) === false)
{
 throw new Error("(errid:Watl000417)字段[修改人(updUser)]的值:[$(pobjgs_PTopicObjectiveRelaEN.updUser)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
if (IsNullOrEmpty(pobjgs_PTopicObjectiveRelaEN.memo) == false && undefined !== pobjgs_PTopicObjectiveRelaEN.memo && tzDataType.isString(pobjgs_PTopicObjectiveRelaEN.memo) === false)
{
 throw new Error("(errid:Watl000417)字段[备注(memo)]的值:[$(pobjgs_PTopicObjectiveRelaEN.memo)], 非法,应该为字符型(In 论文客观关系表(gs_PTopicObjectiveRela))!(clsgs_PTopicObjectiveRelaBL:CheckProperty4Update)");
}
//检查主键是否为Null或者空!
...
*/
export  function gs_PTopicObjectiveRela_GetCombineCondition(objgs_PTopicObjectiveRelaCond: clsgs_PTopicObjectiveRelaEN ):string
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
let strWhereCond = " 1 = 1 ";
//如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_mId) == true)
{
const strComparisonOpmId:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_mId];
strWhereCond += Format(" And {0} {2} {1}", clsgs_PTopicObjectiveRelaEN.con_mId, objgs_PTopicObjectiveRelaCond.mId, strComparisonOpmId);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_PaperId) == true)
{
const strComparisonOpPaperId:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_PaperId];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_PaperId, objgs_PTopicObjectiveRelaCond.paperId, strComparisonOpPaperId);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_SectionId) == true)
{
const strComparisonOpSectionId:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_SectionId];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_SectionId, objgs_PTopicObjectiveRelaCond.sectionId, strComparisonOpSectionId);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_TopicObjectiveId) == true)
{
const strComparisonOpTopicObjectiveId:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_TopicObjectiveId];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_TopicObjectiveId, objgs_PTopicObjectiveRelaCond.topicObjectiveId, strComparisonOpTopicObjectiveId);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_UpdDate) == true)
{
const strComparisonOpUpdDate:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_UpdDate];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_UpdDate, objgs_PTopicObjectiveRelaCond.updDate, strComparisonOpUpdDate);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_UpdUser) == true)
{
const strComparisonOpUpdUser:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_UpdUser];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_UpdUser, objgs_PTopicObjectiveRelaCond.updUser, strComparisonOpUpdUser);
}
if (Object.prototype.hasOwnProperty.call(objgs_PTopicObjectiveRelaCond.dicFldComparisonOp, clsgs_PTopicObjectiveRelaEN.con_Memo) == true)
{
const strComparisonOpMemo:string = objgs_PTopicObjectiveRelaCond.dicFldComparisonOp[clsgs_PTopicObjectiveRelaEN.con_Memo];
strWhereCond += Format(" And {0} {2} '{1}'", clsgs_PTopicObjectiveRelaEN.con_Memo, objgs_PTopicObjectiveRelaCond.memo, strComparisonOpMemo);
}
 return strWhereCond;
}
 ...
 * @returns 条件串(strWhereCond)
 **/
export  function gs_PTopicObjectiveRela_GetUniCondStr(objgs_PTopicObjectiveRelaEN: clsgs_PTopicObjectiveRelaEN ):string
{
let strWhereCond = " 1 = 1 ";
 ...
 * @returns 条件串(strWhereCond)
 **/
export  function gs_PTopicObjectiveRela_GetUniCondStr4Update(objgs_PTopicObjectiveRelaEN: clsgs_PTopicObjectiveRelaEN ):string
{
let strWhereCond = " 1 = 1 ";
 strWhereCond += Format(" and mId <> '{0}'", objgs_PTopicObjectiveRelaEN.mId);
 strWhereCond +=  Format(" and mId = '{0}'", objgs_PTopicObjectiveRelaEN.mId);
