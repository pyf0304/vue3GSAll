 ...
 * @returns 对象
 **/
export async function TextDirect_GetObjByTextDirectIdAsync(
  strTextDirectId: string,
): Promise<clsTextDirectEN | null> {
  const strThisFuncName = 'GetObjByTextDirectIdAsync';

  if (IsNullOrEmpty(strTextDirectId) == true) {
    const strMsg = Format(
      '参数:[strTextDirectId]不能为空!(In clsTextDirectWApi.GetObjByTextDirectIdAsync)',
    );
  ...
  if (strTextDirectId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strTextDirectId]的长度:[{0}]不正确!(clsTextDirectWApi.GetObjByTextDirectIdAsync)',
      strTextDirectId.length,
    );
    console.error(strMsg);
    throw strMsg;
  }
 ...
 * @returns 对象
 */
export async function TextDirect_GetObjByTextDirectIdCache(
  strTextDirectId: string,
  ...
  if (IsNullOrEmpty(strTextDirectId) == true) {
    const strMsg = Format(
      '参数:[strTextDirectId]不能为空!(In clsTextDirectWApi.GetObjByTextDirectIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strTextDirectId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strTextDirectId]的长度:[{0}]不正确!(clsTextDirectWApi.GetObjByTextDirectIdCache)',
      strTextDirectId.length,
    );
    console.error(strMsg);
    throw strMsg;
  ...
  try {
    const arrTextDirectSel = arrTextDirectObjLstCache.filter(
      (x) => x.textDirectId == strTextDirectId,
    );
...
export async function TextDirect_GetObjByTextDirectIdlocalStorage(strTextDirectId: string) {
  ...
  if (IsNullOrEmpty(strTextDirectId) == true) {
    const strMsg = Format(
      '参数:[strTextDirectId]不能为空!(In clsTextDirectWApi.GetObjByTextDirectIdlocalStorage)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strTextDirectId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strTextDirectId]的长度:[{0}]不正确!(clsTextDirectWApi.GetObjByTextDirectIdlocalStorage)',
      strTextDirectId.length,
    );
    console.error(strMsg);
    throw strMsg;
...
export async function TextDirect_UpdateObjInLstCache(objTextDirect: clsTextDirectEN) {
  ...
  try {
    const arrTextDirectObjLstCache = await TextDirect_GetObjLstCache();
    const obj = arrTextDirectObjLstCache.find(
      (x) => x.textDirectName == objTextDirect.textDirectName,
    );
    if (obj != null) {
...
export async function TextDirect_GetNameByTextDirectIdCache(strTextDirectId: string) {
  if (IsNullOrEmpty(strTextDirectId) == true) {
    const strMsg = Format(
      '参数:[strTextDirectId]不能为空!(In clsTextDirectWApi.GetNameByTextDirectIdCache)',
    );
    console.error(strMsg);
    throw strMsg;
  }
  if (strTextDirectId.length != 4) {
    const strMsg = Format(
      '缓存分类变量:[strTextDirectId]的长度:[{0}]不正确!(clsTextDirectWApi.GetNameByTextDirectIdCache)',
      strTextDirectId.length,
    );
    console.error(strMsg);
    throw strMsg;
 ...
 * @returns 返回一个输出字段值
 */
export async function TextDirect_func(
  strInFldName: string,
  ...
  if (clsTextDirectEN.AttributeName.indexOf(strOutFldName) == -1) {
    const strMsg = Format(
      ...
      strOutFldName,
      clsTextDirectEN.AttributeName.join(','),
    );
    console.error(strMsg);
    throw new Error(strMsg);
  }
 ...
 * @returns 返回一个关键字值列表
 */
export async function TextDirect_funcKey(
  strInFldName: string,
  strInValue: any,
 ...
 * @returns 第一条记录对象
 **/
export async function TextDirect_GetFirstObjAsync(
  strWhereCond: string,
): Promise<clsTextDirectEN | null> {
 ...
 * @returns 获取的相应对象列表
 **/
export async function TextDirect_GetObjLstAsync(
  strWhereCond: string,
): Promise<Array<clsTextDirectEN>> {
...
export async function TextDirect_GetSubObjLstCache(objTextDirectCond: clsTextDirectEN) {
  ...
  if (objTextDirectCond.sfFldComparisonOp == null || objTextDirectCond.sfFldComparisonOp == '')
    return arrTextDirectSel;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objTextDirectCond.sfFldComparisonOp,
  );
  ...
  try {
    ...
    const strMsg = Format(
      ...
      e,
      JSON.stringify(objTextDirectCond),
      textDirect_ConstructorName,
      strThisFuncName,
    );
    console.error(strMsg);
 ...
 * @returns 对象列表
 **/
export async function TextDirect_GetObjLstByTextDirectIdLstAsync(
  arrTextDirectId: Array<string>,
): Promise<Array<clsTextDirectEN>> {
 ...
 * @returns 对象列表
 */
export async function TextDirect_GetObjLstByTextDirectIdLstCache(
  arrTextDirectIdLst: Array<string>,
) {
  const strThisFuncName = 'GetObjLstByTextDirectIdLstCache';
  try {
    const arrTextDirectObjLstCache = await TextDirect_GetObjLstCache();
    const arrTextDirectSel = arrTextDirectObjLstCache.filter(
      (x) => arrTextDirectIdLst.indexOf(x.textDirectId) > -1,
    );
    return arrTextDirectSel;
  } catch (e) {
    const strMsg = Format(
 ...
 * @returns 获取的相应对象列表
 **/
export async function TextDirect_GetTopObjLstAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function TextDirect_GetObjLstByRangeAsync(
 ...
 * @returns 获取的相应记录对象列表
 **/
export async function TextDirect_GetObjLstByPagerAsync(
 ...
 * @returns 实际删除记录的个数
 **/
export async function TextDirect_DelTextDirectsAsync(
  arrTextDirectId: Array<string>,
): Promise<number> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function TextDirect_AddNewRecordAsync(
  objTextDirectEN: clsTextDirectEN,
): Promise<boolean> {
 ...
 * @returns 获取相应的记录的对象
 **/
export async function TextDirect_AddNewRecordWithMaxIdAsync(
  objTextDirectEN: clsTextDirectEN,
): Promise<string> {
 ...
 * @returns 返回新添加记录的关键字
 **/
export async function TextDirect_AddNewRecordWithReturnKeyAsync(
  objTextDirectEN: clsTextDirectEN,
): Promise<string> {
 ...
 * @returns 获取修改是否成功？
 **/
export async function TextDirect_UpdateRecordAsync(
  objTextDirectEN: clsTextDirectEN,
): Promise<boolean> {
  const strThisFuncName = 'UpdateRecordAsync';
  const strAction = 'UpdateRecord';
  if (
    objTextDirectEN.sfUpdFldSetStr === undefined ||
    objTextDirectEN.sfUpdFldSetStr === null ||
    objTextDirectEN.sfUpdFldSetStr === ''
  ) {
    const strMsg = Format(
 ...
 * @returns 返回的第一条记录的关键字值
 **/
export async function TextDirect_UpdateWithConditionAsync(
  objTextDirectEN: clsTextDirectEN,
  strWhereCond: string,
): Promise<boolean> {
...
export async function TextDirect_IsExistRecordCache(objTextDirectCond: clsTextDirectEN) {
  ...
  let arrTextDirectSel = arrTextDirectObjLstCache;
  if (objTextDirectCond.sfFldComparisonOp == null || objTextDirectCond.sfFldComparisonOp == '')
    return arrTextDirectSel.length > 0 ? true : false;
  const dicFldComparisonOp: { [index: string]: string } = JSON.parse(
    objTextDirectCond.sfFldComparisonOp,
  );
  //console.log("clsTextDirectWApi->GetSubObjLstCache->dicFldComparisonOp:");
...
export async function TextDirect_Cache(objDiv: HTMLDivElement, strDdlName: string) {
  ...
  BindDdl_ObjLstInDivObj(
    ...
    strDdlName,
    arrObjLstSel,
    clsTextDirectEN.con_TextDirectId,
    clsTextDirectEN.con_TextDirectName,
    '文本方向',
  );
}
...
export function TextDirect_CheckPropertyNew(pobjTextDirectEN: clsTextDirectEN) {
  ...
  if (IsNullOrEmpty(pobjTextDirectEN.textDirectName) === true) {
    throw new Error(
      '(errid:Watl000411)字段[文本方向名]不能为空(In 文本方向)!(clsTextDirectBL:CheckPropertyNew0)',
    );
  }
  //检查字段长度, 若字符型字段长度超出规定的长度,即非法!
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectId) == false &&
    GetStrLen(pobjTextDirectEN.textDirectId) > 4
  ) {
    throw new Error(
      '(errid:Watl000413)字段[文本方向ID(textDirectId)]的长度不能超过4(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.textDirectId)(clsTextDirectBL:CheckPropertyNew)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectName) == false &&
    GetStrLen(pobjTextDirectEN.textDirectName) > 40
  ) {
    throw new Error(
      '(errid:Watl000413)字段[文本方向名(textDirectName)]的长度不能超过40(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.textDirectName)(clsTextDirectBL:CheckPropertyNew)',
    );
  }
  if (IsNullOrEmpty(pobjTextDirectEN.memo) == false && GetStrLen(pobjTextDirectEN.memo) > 1000) {
    throw new Error(
      '(errid:Watl000413)字段[备注(memo)]的长度不能超过1000(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.memo)(clsTextDirectBL:CheckPropertyNew)',
    );
  }
  //检查字段的数据类型是否正确
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectId) == false &&
    undefined !== pobjTextDirectEN.textDirectId &&
    tzDataType.isString(pobjTextDirectEN.textDirectId) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[文本方向ID(textDirectId)]的值:[$(pobjTextDirectEN.textDirectId)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckPropertyNew0)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectName) == false &&
    undefined !== pobjTextDirectEN.textDirectName &&
    tzDataType.isString(pobjTextDirectEN.textDirectName) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[文本方向名(textDirectName)]的值:[$(pobjTextDirectEN.textDirectName)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckPropertyNew0)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.memo) == false &&
    undefined !== pobjTextDirectEN.memo &&
    tzDataType.isString(pobjTextDirectEN.memo) === false
  ) {
    throw new Error(
      '(errid:Watl000414)字段[备注(memo)]的值:[$(pobjTextDirectEN.memo)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckPropertyNew0)',
    );
  }
...
export function TextDirect_CheckProperty4Update(pobjTextDirectEN: clsTextDirectEN) {
  ...
  if (
    ...
    throw new Error(
      '(errid:Watl000416)字段[文本方向ID(textDirectId)]的长度不能超过4(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.textDirectId)(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectName) == false &&
    ...
    throw new Error(
      '(errid:Watl000416)字段[文本方向名(textDirectName)]的长度不能超过40(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.textDirectName)(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  if (IsNullOrEmpty(pobjTextDirectEN.memo) == false && GetStrLen(pobjTextDirectEN.memo) > 1000) {
    throw new Error(
      '(errid:Watl000416)字段[备注(memo)]的长度不能超过1000(In 文本方向(TextDirect))!值:$(pobjTextDirectEN.memo)(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  //检查字段的数据类型是否正确
  if (
    ...
    throw new Error(
      '(errid:Watl000417)字段[文本方向ID(textDirectId)]的值:[$(pobjTextDirectEN.textDirectId)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.textDirectName) == false &&
    ...
    throw new Error(
      '(errid:Watl000417)字段[文本方向名(textDirectName)]的值:[$(pobjTextDirectEN.textDirectName)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  if (
    IsNullOrEmpty(pobjTextDirectEN.memo) == false &&
    ...
    throw new Error(
      '(errid:Watl000417)字段[备注(memo)]的值:[$(pobjTextDirectEN.memo)], 非法,应该为字符型(In 文本方向(TextDirect))!(clsTextDirectBL:CheckProperty4Update)',
    );
  }
  //检查主键是否为Null或者空!
  //检查外键, 作为外键应该和主键的字段长度是一样的, 若不一样,即非法!
 ...
 * @returns 返回一个生成的对象列表
 */
export function TextDirect_GetObjLstByJSONObjLst(
  arrTextDirectObjLstS: Array<clsTextDirectEN>,
): Array<clsTextDirectEN> {
...
export function TextDirect_GetCombineCondition(objTextDirectCond: clsTextDirectEN): string {
  ...
  if (
    Object.prototype.hasOwnProperty.call(
      objTextDirectCond.dicFldComparisonOp,
      clsTextDirectEN.con_TextDirectId,
    ) == true
  ) {
    const strComparisonOpTextDirectId: string =
      objTextDirectCond.dicFldComparisonOp[clsTextDirectEN.con_TextDirectId];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsTextDirectEN.con_TextDirectId,
      objTextDirectCond.textDirectId,
      strComparisonOpTextDirectId,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
    ...
    const strComparisonOpTextDirectName: string =
      objTextDirectCond.dicFldComparisonOp[clsTextDirectEN.con_TextDirectName];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsTextDirectEN.con_TextDirectName,
      objTextDirectCond.textDirectName,
      strComparisonOpTextDirectName,
    );
  }
  if (
    Object.prototype.hasOwnProperty.call(
      objTextDirectCond.dicFldComparisonOp,
      clsTextDirectEN.con_Memo,
    ) == true
  ) {
    const strComparisonOpMemo: string =
      objTextDirectCond.dicFldComparisonOp[clsTextDirectEN.con_Memo];
    strWhereCond += Format(
      " And {0} {2} '{1}'",
      clsTextDirectEN.con_Memo,
      objTextDirectCond.memo,
      strComparisonOpMemo,
    );
  }
  return strWhereCond;
 ...
 */
export function TextDirect_CopyObjTo(
  objTextDirectENS: clsTextDirectEN,
  objTextDirectENT: clsTextDirectEN,
): void {
