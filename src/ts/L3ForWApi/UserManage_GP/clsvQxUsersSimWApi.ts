...
//该表没有使用Cache,不需要生成[vQxUsersSim__funcKey]函数;(in AutoGCLib.WA_Access4TypeScript:Gen_4WA_Ts_funcKey)
 ...
 * @returns 获取的相应记录对象列表
 **/
export  async function vQxUsersSim_GetObjLstByPagerAsync(objPagerPara: stuPagerPara): Promise<Array<clsvQxUsersSimEN>>  
{
const strThisFuncName = "GetObjLstByPagerAsync";
if (objPagerPara.pageIndex == 0) return new Array<clsvQxUsersSimEN>();
...
*/
export  async function vQxUsersSim_BindDdl_UserIdInDiv(objDiv: HTMLDivElement, strDdlName: string )
{
...
const arrObjLstSel = await vQxUsersSim_GetObjLstAsync(strCondition);
