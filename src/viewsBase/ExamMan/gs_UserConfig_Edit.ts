...
import {
  gs_UserConfig_CheckPropertyNew,
  gs_UserConfig_AddNewRecordAsync,
  gs_UserConfig_ReFreshCache,
  gs_UserConfig_GetUniCondStr,
  gs_UserConfig_IsExistRecordAsync,
  gs_UserConfig_GetUniCondStr4Update,
  gs_UserConfig_IsExistAsync,
  gs_UserConfig_GetObjByConfigIdAsync,
  gs_UserConfig_CheckProperty4Update,
...
export abstract class gs_UserConfig_Edit {
  ...
  public static objPageEdit: gs_UserConfig_Edit;
  public static objPageEdit2: gs_UserConfig_Edit;
  public static objPageEdit3: gs_UserConfig_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (gs_UserConfig_Edit.SetPageEdit(this, 1) == true) return;
    if (gs_UserConfig_Edit.SetPageEdit(this, 2) == true) return;
    if (gs_UserConfig_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (gs_UserConfig_Edit.objPageEdit == null) {
          gs_UserConfig_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_UserConfig_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (gs_UserConfig_Edit.objPageEdit2 == null) {
          gs_UserConfig_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_UserConfig_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            gs_UserConfig_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (gs_UserConfig_Edit.objPageEdit3 == null) {
          gs_UserConfig_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_UserConfig_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            gs_UserConfig_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (gs_UserConfig_Edit.objPageEdit != null) {
      const strClassNameOld = gs_UserConfig_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return gs_UserConfig_Edit.objPageEdit;
    }
    if (gs_UserConfig_Edit.objPageEdit2 != null) {
      const strClassNameOld = gs_UserConfig_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return gs_UserConfig_Edit.objPageEdit2;
    }
    if (gs_UserConfig_Edit.objPageEdit3 != null) {
      const strClassNameOld = gs_UserConfig_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return gs_UserConfig_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_gs_UserConfig() {
    if (gs_UserConfig_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      gs_UserConfig_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_gs_UserConfig(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_gs_UserConfig.name;
    if (gs_UserConfig_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (gs_UserConfig_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await gs_UserConfig_Edit.EditObj.showDialog();
    }
    this.divEdit = gs_UserConfig_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (gs_UserConfig_Edit.times4TestShowDialog < 2) {
        gs_UserConfig_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_gs_UserConfig(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      gs_UserConfig_Edit.times4TestShowDialog = 0;
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitgs_UserConfig = '确认添加';
      this.btnCancelgs_UserConfig = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitgs_UserConfig = '确认修改';
      this.btnCancelgs_UserConfig = '取消修改';
    }
    return true;
  }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (gs_UserConfig_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (gs_UserConfig_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_gs_UserConfig(this.opType);
  ...
  public async btnSubmit_Click() {
    ...
    const strCommandText: string = this.btnSubmitgs_UserConfig;
    try {
      ...
      switch (strCommandText) {
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            //{
            //gs_UserConfig_Edit.EditObj.hideDialog();
            //this.iShowList.BindGvCache(clsgs_UserConfigEN._CurrTabName, "");
            //}
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsgs_UserConfigEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucgs_UserConfigB1.configId = gs_UserConfigGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.configId = await gs_UserConfig_GetMaxStrIdAsync();
  }
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objgs_UserConfigEN);
   ...
   **/
  public async CheckUniCond4Add(objgs_UserConfigEN: clsgs_UserConfigEN): Promise<boolean> {
    const strUniquenessCondition = gs_UserConfig_GetUniCondStr(objgs_UserConfigEN);
   ...
   **/
  public async CheckUniCond4Update(objgs_UserConfigEN: clsgs_UserConfigEN): Promise<boolean> {
    const strUniquenessCondition = gs_UserConfig_GetUniCondStr4Update(objgs_UserConfigEN);
    const bolIsExistCondition = await gs_UserConfig_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async ShowData(lngConfigId: number) {
    ...
    try {
      const objgs_UserConfigENConst = await gs_UserConfig_GetObjByConfigIdAsync(lngConfigId);
      if (objgs_UserConfigENConst == null) {
        const strMsg = Format(
      ...
      objgs_UserConfigEN = objgs_UserConfigENConst;
    } catch (e) {
      const strMsg = Format(
   ...
   **/
  public async GetDataFromgs_UserConfigClass(pobjgs_UserConfigEN: clsgs_UserConfigEN) {
  ...
  public async UpdateRecord(lngConfigId: number): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromgs_UserConfigClass(objgs_UserConfigEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    const objgs_UserConfigEN = new clsgs_UserConfigEN();
    objgs_UserConfigEN.SetConfigId(Number(this.keyId));
    await this.PutDataTogs_UserConfigClass(objgs_UserConfigEN);
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objgs_UserConfigEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelgs_UserConfig(value: string) {
    gs_UserConfig_Edit.EditObj.SetButtonText('btnCancelgs_UserConfig', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitgs_UserConfig(): string {
    const strValue = gs_UserConfig_Edit.EditObj.GetButtonText('btnSubmitgs_UserConfig');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitgs_UserConfig(value: string) {
    gs_UserConfig_Edit.EditObj.SetButtonText('btnSubmitgs_UserConfig', value);
  }
  /**
   * 配置类型Id (Used In Clear())
   **/
  public set configTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtConfigTypeId', value);
  }
  /**
   * 配置类型Id (Used In PutDataToClass())
   **/
  public get configTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtConfigTypeId');
