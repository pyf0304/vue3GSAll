...
import {
  ...
  gs_TobeStudiedProblem_CheckPropertyNew,
  gs_TobeStudiedProblem_AddNewRecordWithMaxIdAsync,
  gs_TobeStudiedProblem_ReFreshCache,
  gs_TobeStudiedProblem_GetUniCondStr,
  gs_TobeStudiedProblem_IsExistRecordAsync,
  gs_TobeStudiedProblem_GetUniCondStr4Update,
  gs_TobeStudiedProblem_IsExistAsync,
  gs_TobeStudiedProblem_GetObjByProblemIdAsync,
  gs_TobeStudiedProblem_CheckProperty4Update,
...
export abstract class gs_TobeStudiedProblem_Edit {
  ...
  public static objPageEdit: gs_TobeStudiedProblem_Edit;
  public static objPageEdit2: gs_TobeStudiedProblem_Edit;
  public static objPageEdit3: gs_TobeStudiedProblem_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (gs_TobeStudiedProblem_Edit.SetPageEdit(this, 1) == true) return;
    if (gs_TobeStudiedProblem_Edit.SetPageEdit(this, 2) == true) return;
    if (gs_TobeStudiedProblem_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (gs_TobeStudiedProblem_Edit.objPageEdit == null) {
          gs_TobeStudiedProblem_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (gs_TobeStudiedProblem_Edit.objPageEdit2 == null) {
          gs_TobeStudiedProblem_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            gs_TobeStudiedProblem_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (gs_TobeStudiedProblem_Edit.objPageEdit3 == null) {
          gs_TobeStudiedProblem_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            gs_TobeStudiedProblem_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (gs_TobeStudiedProblem_Edit.objPageEdit != null) {
      const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return gs_TobeStudiedProblem_Edit.objPageEdit;
    }
    if (gs_TobeStudiedProblem_Edit.objPageEdit2 != null) {
      const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return gs_TobeStudiedProblem_Edit.objPageEdit2;
    }
    if (gs_TobeStudiedProblem_Edit.objPageEdit3 != null) {
      const strClassNameOld = gs_TobeStudiedProblem_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return gs_TobeStudiedProblem_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_gs_TobeStudiedProblem() {
    if (gs_TobeStudiedProblem_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      gs_TobeStudiedProblem_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_gs_TobeStudiedProblem(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_gs_TobeStudiedProblem.name;
    if (gs_TobeStudiedProblem_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (gs_TobeStudiedProblem_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await gs_TobeStudiedProblem_Edit.EditObj.showDialog();
    }
    this.divEdit = gs_TobeStudiedProblem_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (gs_TobeStudiedProblem_Edit.times4TestShowDialog < 2) {
        gs_TobeStudiedProblem_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_gs_TobeStudiedProblem(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      gs_TobeStudiedProblem_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (gs_TobeStudiedProblem_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (gs_TobeStudiedProblem_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_gs_TobeStudiedProblem(this.opType);
  ...
  public async BindDdl4EditRegionInDiv() {
    const IdCurrEduClsStatic = gs_TobeStudiedProblem_Edit.IdCurrEduClsStatic; //静态变量;//静态变量
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsgs_TobeStudiedProblemEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsgs_TobeStudiedProblemEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucgs_TobeStudiedProblemB1.problemId = gs_TobeStudiedProblemGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.problemId = await gs_TobeStudiedProblem_GetMaxStrIdAsync();
    try {
      const returnString = await gs_TobeStudiedProblem_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表gs_TobeStudiedProblem的最大关键字为空,不成功,请检查!');
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objgs_TobeStudiedProblemEN);
      if (bolIsExistCond == false) {
        return false;
      }
      let returnBool = false;
      const returnKeyId = await gs_TobeStudiedProblem_AddNewRecordWithMaxIdAsync(
  ...
  public async CheckUniCond4Add(
    ...
    const strUniquenessCondition = gs_TobeStudiedProblem_GetUniCondStr(objgs_TobeStudiedProblemEN);
    const bolIsExistCondition = await gs_TobeStudiedProblem_IsExistRecordAsync(
  ...
  public async CheckUniCond4Update(
    ...
    const strUniquenessCondition = gs_TobeStudiedProblem_GetUniCondStr4Update(
      objgs_TobeStudiedProblemEN,
    );
    const bolIsExistCondition = await gs_TobeStudiedProblem_IsExistRecordAsync(
      strUniquenessCondition,
  ...
  public async ShowData(strProblemId: string) {
    ...
    try {
      const objgs_TobeStudiedProblemENConst = await gs_TobeStudiedProblem_GetObjByProblemIdAsync(
        strProblemId,
      );
      if (objgs_TobeStudiedProblemENConst == null) {
        const strMsg = Format(
      ...
      objgs_TobeStudiedProblemEN = objgs_TobeStudiedProblemENConst;
    } catch (e) {
      const strMsg = Format(
  ...
  public async UpdateRecord(strProblemId: string): Promise<boolean> {
    ...
    try {
      const objgs_TobeStudiedProblemEN = await gs_TobeStudiedProblem_GetObjByProblemIdAsync(
        strProblemId,
      );
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objgs_TobeStudiedProblemEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelgs_TobeStudiedProblem(value: string) {
    gs_TobeStudiedProblem_Edit.EditObj.SetButtonText('btnCancelgs_TobeStudiedProblem', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitgs_TobeStudiedProblem(): string {
    const strValue = gs_TobeStudiedProblem_Edit.EditObj.GetButtonText(
      'btnSubmitgs_TobeStudiedProblem',
    );
    return strValue;
  }
  /**
   ...
   **/
  public set btnSubmitgs_TobeStudiedProblem(value: string) {
    gs_TobeStudiedProblem_Edit.EditObj.SetButtonText('btnSubmitgs_TobeStudiedProblem', value);
  }
  /**
   * 是否提交 (Used In Clear())
   **/
  ...
  public set month(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMonth', value);
  }
  /**
  ...
  public set participant(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtParticipant', value);
  }
  /**
   * 参与者 (Used In PutDataToClass())
   **/
  public get participant(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtParticipant');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set problemContent(value: string) {
    SetTextAreaValueInDivObj(this.divEdit, 'txtProblemContent', value);
  }
  /**
   * 问题内容 (Used In PutDataToClass())
   **/
  public get problemContent(): string {
    const strValue = GetTextAreaValueInDivObj(this.divEdit, 'txtProblemContent');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set problemDate(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtProblemDate', value);
  }
  /**
   * 问题日期 (Used In PutDataToClass())
   **/
  public get problemDate(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtProblemDate');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set problemId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtProblemId', value);
  }
  /**
   * 问题Id (Used In PutDataToClass())
   **/
  public get problemId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtProblemId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set problemTitle(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtProblemTitle', value);
  }
  /**
   * 问题标题 (Used In PutDataToClass())
   **/
  public get problemTitle(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtProblemTitle');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set year(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtYear', value);
  }
  /**
   * 年 (Used In PutDataToClass())
   **/
  public get year(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtYear');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
}
