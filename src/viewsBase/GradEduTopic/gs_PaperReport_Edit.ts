...
import {
  gs_PaperReport_GetMaxStrIdAsync,
  gs_PaperReport_CheckPropertyNew,
  gs_PaperReport_AddNewRecordWithMaxIdAsync,
  gs_PaperReport_ReFreshCache,
  gs_PaperReport_GetUniCondStr,
  gs_PaperReport_IsExistRecordAsync,
  gs_PaperReport_GetUniCondStr4Update,
  gs_PaperReport_IsExistAsync,
  gs_PaperReport_GetObjByReportIdAsync,
  gs_PaperReport_CheckProperty4Update,
...
export abstract class gs_PaperReport_Edit {
  ...
  public static objPageEdit: gs_PaperReport_Edit;
  public static objPageEdit2: gs_PaperReport_Edit;
  public static objPageEdit3: gs_PaperReport_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (gs_PaperReport_Edit.SetPageEdit(this, 1) == true) return;
    if (gs_PaperReport_Edit.SetPageEdit(this, 2) == true) return;
    if (gs_PaperReport_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (gs_PaperReport_Edit.objPageEdit == null) {
          gs_PaperReport_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_PaperReport_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (gs_PaperReport_Edit.objPageEdit2 == null) {
          gs_PaperReport_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_PaperReport_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            gs_PaperReport_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (gs_PaperReport_Edit.objPageEdit3 == null) {
          gs_PaperReport_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_PaperReport_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            gs_PaperReport_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (gs_PaperReport_Edit.objPageEdit != null) {
      const strClassNameOld = gs_PaperReport_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return gs_PaperReport_Edit.objPageEdit;
    }
    if (gs_PaperReport_Edit.objPageEdit2 != null) {
      const strClassNameOld = gs_PaperReport_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return gs_PaperReport_Edit.objPageEdit2;
    }
    if (gs_PaperReport_Edit.objPageEdit3 != null) {
      const strClassNameOld = gs_PaperReport_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return gs_PaperReport_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_gs_PaperReport() {
    if (gs_PaperReport_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      gs_PaperReport_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_gs_PaperReport(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_gs_PaperReport.name;
    if (gs_PaperReport_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (gs_PaperReport_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await gs_PaperReport_Edit.EditObj.showDialog();
    }
    this.divEdit = gs_PaperReport_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (gs_PaperReport_Edit.times4TestShowDialog < 2) {
        gs_PaperReport_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_gs_PaperReport(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      gs_PaperReport_Edit.times4TestShowDialog = 0;
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitgs_PaperReport = '确认添加';
      this.btnCancelgs_PaperReport = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitgs_PaperReport = '确认修改';
      this.btnCancelgs_PaperReport = '取消修改';
    }
    return true;
  }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (gs_PaperReport_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (gs_PaperReport_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_gs_PaperReport(this.opType);
  ...
  public async BindDdl4EditRegionInDiv() {
    const IdCurrEduClsStatic = gs_PaperReport_Edit.IdCurrEduClsStatic; //静态变量;//静态变量
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsgs_PaperReportEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsgs_PaperReportEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucgs_PaperReportB1.reportId = gs_PaperReportGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.reportId = await gs_PaperReport_GetMaxStrIdAsync();
    try {
      const returnString = await gs_PaperReport_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表gs_PaperReport的最大关键字为空,不成功,请检查!');
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objgs_PaperReportEN);
   ...
   **/
  public async CheckUniCond4Add(objgs_PaperReportEN: clsgs_PaperReportEN): Promise<boolean> {
    const strUniquenessCondition = gs_PaperReport_GetUniCondStr(objgs_PaperReportEN);
   ...
   **/
  public async CheckUniCond4Update(objgs_PaperReportEN: clsgs_PaperReportEN): Promise<boolean> {
    const strUniquenessCondition = gs_PaperReport_GetUniCondStr4Update(objgs_PaperReportEN);
    const bolIsExistCondition = await gs_PaperReport_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async ShowData(strReportId: string) {
    ...
    try {
      const objgs_PaperReportENConst = await gs_PaperReport_GetObjByReportIdAsync(strReportId);
      if (objgs_PaperReportENConst == null) {
        const strMsg = Format(
      ...
      objgs_PaperReportEN = objgs_PaperReportENConst;
    } catch (e) {
      const strMsg = Format(
  ...
  public async UpdateRecord(strReportId: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromgs_PaperReportClass(objgs_PaperReportEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objgs_PaperReportEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelgs_PaperReport(value: string) {
    gs_PaperReport_Edit.EditObj.SetButtonText('btnCancelgs_PaperReport', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitgs_PaperReport(): string {
    const strValue = gs_PaperReport_Edit.EditObj.GetButtonText('btnSubmitgs_PaperReport');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitgs_PaperReport(value: string) {
    gs_PaperReport_Edit.EditObj.SetButtonText('btnSubmitgs_PaperReport', value);
  }
  /**
   * 备注 (Used In Clear())
   **/
  ...
  public set pDFUrl(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtPDFUrl', value);
  }
  /**
   * PDFUrl (Used In PutDataToClass())
   **/
  public get pDFUrl(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtPDFUrl');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set pPTUrl(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtPPTUrl', value);
  }
  /**
   * PPTUrl (Used In PutDataToClass())
   **/
  public get pPTUrl(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtPPTUrl');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set reportContent(value: string) {
    SetTextAreaValueInDivObj(this.divEdit, 'txtReportContent', value);
  }
  /**
   * 汇报内容 (Used In PutDataToClass())
   **/
  public get reportContent(): string {
    const strValue = GetTextAreaValueInDivObj(this.divEdit, 'txtReportContent');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set reportDate(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtReportDate', value);
  }
  /**
   * 汇报日期 (Used In PutDataToClass())
   **/
  public get reportDate(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtReportDate');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set reportId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtReportId', value);
  }
  /**
   * 汇报Id (Used In PutDataToClass())
   **/
  public get reportId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtReportId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set reportUser(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtReportUser', value);
  }
  /**
   * 汇报用户 (Used In PutDataToClass())
   **/
  public get reportUser(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtReportUser');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
