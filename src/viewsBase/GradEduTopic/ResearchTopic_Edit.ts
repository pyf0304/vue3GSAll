...
import {
  ...
  ResearchTopic_CheckPropertyNew,
  ResearchTopic_AddNewRecordWithMaxIdAsync,
  ResearchTopic_ReFreshCache,
  ResearchTopic_GetUniCondStr,
  ResearchTopic_IsExistRecordAsync,
  ResearchTopic_GetUniCondStr4Update,
  ResearchTopic_IsExistAsync,
  ResearchTopic_GetObjByTopicIdAsync,
  ResearchTopic_CheckProperty4Update,
...
export abstract class ResearchTopic_Edit {
  ...
  public static objPageEdit: ResearchTopic_Edit;
  public static objPageEdit2: ResearchTopic_Edit;
  public static objPageEdit3: ResearchTopic_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (ResearchTopic_Edit.SetPageEdit(this, 1) == true) return;
    if (ResearchTopic_Edit.SetPageEdit(this, 2) == true) return;
    if (ResearchTopic_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (ResearchTopic_Edit.objPageEdit == null) {
          ResearchTopic_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = ResearchTopic_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (ResearchTopic_Edit.objPageEdit2 == null) {
          ResearchTopic_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ResearchTopic_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            ResearchTopic_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (ResearchTopic_Edit.objPageEdit3 == null) {
          ResearchTopic_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = ResearchTopic_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            ResearchTopic_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (ResearchTopic_Edit.objPageEdit != null) {
      const strClassNameOld = ResearchTopic_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return ResearchTopic_Edit.objPageEdit;
    }
    if (ResearchTopic_Edit.objPageEdit2 != null) {
      const strClassNameOld = ResearchTopic_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return ResearchTopic_Edit.objPageEdit2;
    }
    if (ResearchTopic_Edit.objPageEdit3 != null) {
      const strClassNameOld = ResearchTopic_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return ResearchTopic_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_ResearchTopic() {
    if (ResearchTopic_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      ResearchTopic_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_ResearchTopic(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_ResearchTopic.name;
    if (ResearchTopic_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (ResearchTopic_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await ResearchTopic_Edit.EditObj.showDialog();
    }
    this.divEdit = ResearchTopic_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (ResearchTopic_Edit.times4TestShowDialog < 2) {
        ResearchTopic_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_ResearchTopic(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      ResearchTopic_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (ResearchTopic_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (ResearchTopic_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsResearchTopicEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsResearchTopicEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucResearchTopicB1.topicId = ResearchTopicGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.topicId = await ResearchTopic_GetMaxStrIdAsync();
    try {
      const returnString = await ResearchTopic_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表ResearchTopic的最大关键字为空,不成功,请检查!');
  ...
  public async PutDataToResearchTopicClass(pobjResearchTopicEN: clsResearchTopicEN) {
    ...
    pobjResearchTopicEN.SetIdCurrEduCls(ResearchTopic_Edit.IdCurrEduClsStatic); // 教学班流水号
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objResearchTopicEN);
      ...
      if (returnBool == true) {
        ResearchTopic_ReFreshCache(ResearchTopic_Edit.IdCurrEduClsCache);
   ...
   **/
  public async CheckUniCond4Add(objResearchTopicEN: clsResearchTopicEN): Promise<boolean> {
    const strUniquenessCondition = ResearchTopic_GetUniCondStr(objResearchTopicEN);
   ...
   **/
  public async CheckUniCond4Update(objResearchTopicEN: clsResearchTopicEN): Promise<boolean> {
    const strUniquenessCondition = ResearchTopic_GetUniCondStr4Update(objResearchTopicEN);
    const bolIsExistCondition = await ResearchTopic_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async ShowData(strTopicId: string) {
    ...
    try {
      const objResearchTopicENConst = await ResearchTopic_GetObjByTopicIdAsync(strTopicId);
      if (objResearchTopicENConst == null) {
        const strMsg = Format(
      ...
      objResearchTopicEN = objResearchTopicENConst;
    } catch (e) {
      const strMsg = Format(
  ...
  public async UpdateRecord(strTopicId: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromResearchTopicClass(objResearchTopicEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objResearchTopicEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelResearchTopic(value: string) {
    ResearchTopic_Edit.EditObj.SetButtonText('btnCancelResearchTopic', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitResearchTopic(): string {
    const strValue = ResearchTopic_Edit.EditObj.GetButtonText('btnSubmitResearchTopic');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitResearchTopic(value: string) {
    ResearchTopic_Edit.EditObj.SetButtonText('btnSubmitResearchTopic', value);
  }
  /**
   * 是否提交 (Used In Clear())
   **/
  ...
  public set topicContent(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtTopicContent', value);
  }
  /**
   * 主题内容 (Used In PutDataToClass())
   **/
  public get topicContent(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtTopicContent');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set topicName(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtTopicName', value);
  }
  /**
   * 栏目主题 (Used In PutDataToClass())
   **/
  public get topicName(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtTopicName');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set topicProposePeople(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtTopicProposePeople', value);
  }
  /**
   * 主题提出人 (Used In PutDataToClass())
   **/
  public get topicProposePeople(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtTopicProposePeople');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
