...
import {
  gs_ResearchResult_GetMaxStrIdAsync,
  gs_ResearchResult_CheckPropertyNew,
  gs_ResearchResult_AddNewRecordWithMaxIdAsync,
  gs_ResearchResult_ReFreshCache,
  gs_ResearchResult_GetUniCondStr,
  gs_ResearchResult_IsExistRecordAsync,
  gs_ResearchResult_GetUniCondStr4Update,
  gs_ResearchResult_IsExistAsync,
  gs_ResearchResult_GetObjByResultIdAsync,
  gs_ResearchResult_CheckProperty4Update,
...
export abstract class gs_ResearchResult_Edit {
  ...
  public static objPageEdit: gs_ResearchResult_Edit;
  public static objPageEdit2: gs_ResearchResult_Edit;
  public static objPageEdit3: gs_ResearchResult_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (gs_ResearchResult_Edit.SetPageEdit(this, 1) == true) return;
    if (gs_ResearchResult_Edit.SetPageEdit(this, 2) == true) return;
    if (gs_ResearchResult_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (gs_ResearchResult_Edit.objPageEdit == null) {
          gs_ResearchResult_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_ResearchResult_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (gs_ResearchResult_Edit.objPageEdit2 == null) {
          gs_ResearchResult_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_ResearchResult_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            gs_ResearchResult_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (gs_ResearchResult_Edit.objPageEdit3 == null) {
          gs_ResearchResult_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = gs_ResearchResult_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            gs_ResearchResult_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (gs_ResearchResult_Edit.objPageEdit != null) {
      const strClassNameOld = gs_ResearchResult_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return gs_ResearchResult_Edit.objPageEdit;
    }
    if (gs_ResearchResult_Edit.objPageEdit2 != null) {
      const strClassNameOld = gs_ResearchResult_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return gs_ResearchResult_Edit.objPageEdit2;
    }
    if (gs_ResearchResult_Edit.objPageEdit3 != null) {
      const strClassNameOld = gs_ResearchResult_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return gs_ResearchResult_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_gs_ResearchResult() {
    if (gs_ResearchResult_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      gs_ResearchResult_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_gs_ResearchResult(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_gs_ResearchResult.name;
    if (gs_ResearchResult_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (gs_ResearchResult_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await gs_ResearchResult_Edit.EditObj.showDialog();
    }
    this.divEdit = gs_ResearchResult_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (gs_ResearchResult_Edit.times4TestShowDialog < 2) {
        gs_ResearchResult_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_gs_ResearchResult(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      gs_ResearchResult_Edit.times4TestShowDialog = 0;
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitgs_ResearchResult = '确认添加';
      this.btnCancelgs_ResearchResult = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitgs_ResearchResult = '确认修改';
      this.btnCancelgs_ResearchResult = '取消修改';
    }
    return true;
  }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (gs_ResearchResult_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (gs_ResearchResult_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_gs_ResearchResult(this.opType);
  ...
  public async BindDdl4EditRegionInDiv() {
    const IdCurrEduClsStatic = gs_ResearchResult_Edit.IdCurrEduClsStatic; //静态变量;//静态变量
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsgs_ResearchResultEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsgs_ResearchResultEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucgs_ResearchResultB1.resultId = gs_ResearchResultGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.resultId = await gs_ResearchResult_GetMaxStrIdAsync();
    try {
      const returnString = await gs_ResearchResult_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表gs_ResearchResult的最大关键字为空,不成功,请检查!');
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objgs_ResearchResultEN);
      if (bolIsExistCond == false) {
        return false;
      }
      let returnBool = false;
      const returnKeyId = await gs_ResearchResult_AddNewRecordWithMaxIdAsync(
   ...
   **/
  public async CheckUniCond4Add(objgs_ResearchResultEN: clsgs_ResearchResultEN): Promise<boolean> {
    const strUniquenessCondition = gs_ResearchResult_GetUniCondStr(objgs_ResearchResultEN);
  ...
  public async CheckUniCond4Update(
    ...
    const strUniquenessCondition = gs_ResearchResult_GetUniCondStr4Update(objgs_ResearchResultEN);
    const bolIsExistCondition = await gs_ResearchResult_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async ShowData(strResultId: string) {
    ...
    try {
      const objgs_ResearchResultENConst = await gs_ResearchResult_GetObjByResultIdAsync(
        strResultId,
      );
      if (objgs_ResearchResultENConst == null) {
        const strMsg = Format(
      ...
      objgs_ResearchResultEN = objgs_ResearchResultENConst;
    } catch (e) {
      const strMsg = Format(
  ...
  public async UpdateRecord(strResultId: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromgs_ResearchResultClass(objgs_ResearchResultEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objgs_ResearchResultEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelgs_ResearchResult(value: string) {
    gs_ResearchResult_Edit.EditObj.SetButtonText('btnCancelgs_ResearchResult', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitgs_ResearchResult(): string {
    const strValue = gs_ResearchResult_Edit.EditObj.GetButtonText('btnSubmitgs_ResearchResult');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitgs_ResearchResult(value: string) {
    gs_ResearchResult_Edit.EditObj.SetButtonText('btnSubmitgs_ResearchResult', value);
  }
  /**
   * 分工 (Used In Clear())
   **/
  public set division(value: string) {
    SetTextAreaValueInDivObj(this.divEdit, 'txtDivision', value);
  }
  /**
   * 分工 (Used In PutDataToClass())
   **/
  public get division(): string {
    const strValue = GetTextAreaValueInDivObj(this.divEdit, 'txtDivision');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set resultContent(value: string) {
    SetTextAreaValueInDivObj(this.divEdit, 'txtResultContent', value);
  }
  /**
   * 成果内容 (Used In PutDataToClass())
   **/
  public get resultContent(): string {
    const strValue = GetTextAreaValueInDivObj(this.divEdit, 'txtResultContent');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set resultId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtResultId', value);
  }
  /**
   * 成果Id (Used In PutDataToClass())
   **/
  public get resultId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtResultId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set resultName(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtResultName', value);
  }
  /**
   * 成果名称 (Used In PutDataToClass())
   **/
  public get resultName(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtResultName');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set resultTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtResultTypeId', value);
  }
  /**
   * 成果类型Id (Used In PutDataToClass())
   **/
  public get resultTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtResultTypeId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
