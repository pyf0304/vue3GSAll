 ...
 **/
import $ from 'jquery';
import { XzMajorShoolType_BindDdl_IdXzMajorShoolTypeInDivCache } from '@/ts/L3ForWApi/BaseInfo/clsXzMajorShoolTypeWApi';
...
import {
  ...
  XzMajor_CheckPropertyNew,
  XzMajor_AddNewRecordWithMaxIdAsync,
  XzMajor_ReFreshCache,
  XzMajor_GetUniCondStr,
  XzMajor_IsExistRecordAsync,
  XzMajor_GetUniCondStr4Update,
  XzMajor_IsExistAsync,
  XzMajor_GetObjByIdXzMajorAsync,
  XzMajor_CheckProperty4Update,
  XzMajor_UpdateRecordAsync,
...
export abstract class XzMajor_Edit {
  ...
  public HideDialog_XzMajor() {
    if (XzMajor_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      XzMajor_Edit.EditObj.hideDialog();
    }
  }
  ...
  public async ShowDialog_XzMajor(strOp: string): Promise<boolean> {
    ...
    if (XzMajor_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      ...
      await XzMajor_Edit.EditObj.showDialog();
    }
    this.divEdit = XzMajor_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (XzMajor_Edit.times4TestShowDialog < 2) {
        XzMajor_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_XzMajor(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      XzMajor_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (XzMajor_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (XzMajor_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async BindDdl4EditRegionInDiv() {
    await this.SetDdl_IdXzMajorShoolTypeInDiv(); //编辑区域
  ...
  /**
   * 设置绑定下拉框，针对字段:[IdXzMajorShoolType]
   * (AGC.PureClassEx.clsASPDropDownListBLEx_Static:GC_SetBindDdl4TabFeature4QueryEdit_TS)
   **/

  public async SetDdl_IdXzMajorShoolTypeInDiv() {
    await XzMajorShoolType_BindDdl_IdXzMajorShoolTypeInDivCache(
      this.divEdit,
      'ddlIdXzMajorShoolType',
    ); //
  }
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsXzMajorEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsXzMajorEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public Clear() {
    ...
    this.majorExplain = '';
    ClearSelectValueByIdInDivObj(this.divEdit, 'ddlIdXzMajorShoolType');
   ...
   **/
  public async GetDataFromXzMajorClass(pobjXzMajorEN: clsXzMajorEN) {
  ...
  public async UpdateRecord(strIdXzMajor: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromXzMajorClass(objXzMajorEN);
  ...
  public set btnCancelXzMajor(value: string) {
    XzMajor_Edit.EditObj.SetButtonText('btnCancelXzMajor', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitXzMajor(): string {
    const strValue = XzMajor_Edit.EditObj.GetButtonText('btnSubmitXzMajor');
    return strValue;
  }
  /**
  ...
  public set btnSubmitXzMajor(value: string) {
    XzMajor_Edit.EditObj.SetButtonText('btnSubmitXzMajor', value);
  }
  /**
   * 学院流水号 (Used In Clear())
   **/
  ...
  public set idXzMajorShoolType(value: string) {
    SetSelectValueByIdInDivObj(this.divEdit, 'ddlIdXzMajorShoolType', value);
  }
  /**
   * 专业学校类型流水号 (Used In PutDataToClass())
   **/
  public get idXzMajorShoolType(): string {
    const strValue = GetSelectValueInDivObj(this.divEdit, 'ddlIdXzMajorShoolType');
    if (strValue == undefined) return '';
    else if (strValue == '0') return '';
    else return strValue;
  }
  ...
  public set majorDirection(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMajorDirection', value);
  }
  /**
   * 专业方向 (Used In PutDataToClass())
   **/
  public get majorDirection(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMajorDirection');
    if (strValue == undefined) return '';
  ...
  public set majorEnglishName(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMajorEnglishName', value);
  }
  /**
   * 专业英文名称 (Used In PutDataToClass())
   **/
  public get majorEnglishName(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMajorEnglishName');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set majorExplain(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMajorExplain', value);
  }
  /**
   * 专业说明 (Used In PutDataToClass())
   **/
  public get majorExplain(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMajorExplain');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set majorID(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMajorID', value);
  }
  /**
   * 专业ID (Used In PutDataToClass())
   **/
  public get majorID(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMajorID');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set majorName(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMajorName', value);
  }
  /**
   * 专业名称 (Used In PutDataToClass())
   **/
  public get majorName(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMajorName');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
