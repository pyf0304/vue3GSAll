...
import {
  gs_TeachingDate_CheckPropertyNew,
  gs_TeachingDate_AddNewRecordAsync,
  gs_TeachingDate_ReFreshCache,
  gs_TeachingDate_GetUniCondStr,
  gs_TeachingDate_IsExistRecordAsync,
  gs_TeachingDate_GetUniCondStr4Update,
  gs_TeachingDate_IsExistAsync,
  gs_TeachingDate_GetObjBymIdAsync,
  gs_TeachingDate_CheckProperty4Update,
...
export abstract class gs_TeachingDate_Edit {
  ...
  public HideDialog_gs_TeachingDate() {
    if (gs_TeachingDate_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      gs_TeachingDate_Edit.EditObj.hideDialog();
    }
  }
  ...
  public async ShowDialog_gs_TeachingDate(strOp: string): Promise<boolean> {
    ...
    if (gs_TeachingDate_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (gs_TeachingDate_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await gs_TeachingDate_Edit.EditObj.showDialog();
    }
    this.divEdit = gs_TeachingDate_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (gs_TeachingDate_Edit.times4TestShowDialog < 2) {
        gs_TeachingDate_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_gs_TeachingDate(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      gs_TeachingDate_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (gs_TeachingDate_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (gs_TeachingDate_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
      ...
      switch (strCommandText) {
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            //{
            //gs_TeachingDate_Edit.EditObj.hideDialog();
            //this.iShowList.BindGvCache(clsgs_TeachingDateEN._CurrTabName, "");
            //}
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsgs_TeachingDateEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async PutDataTogs_TeachingDateClass(pobjgs_TeachingDateEN: clsgs_TeachingDateEN) {
    pobjgs_TeachingDateEN.SetIdCurrEduCls(this.idCurrEduCls); // 当前教学班流水号
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      ...
      if (returnBool == true) {
        gs_TeachingDate_ReFreshCache(gs_TeachingDate_Edit.IdCurrEduClsCache);
  ...
  public set btnCancelgs_TeachingDate(value: string) {
    gs_TeachingDate_Edit.EditObj.SetButtonText('btnCancelgs_TeachingDate', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitgs_TeachingDate(): string {
    const strValue = gs_TeachingDate_Edit.EditObj.GetButtonText('btnSubmitgs_TeachingDate');
    return strValue;
  }
  /**
  ...
  public set btnSubmitgs_TeachingDate(value: string) {
    gs_TeachingDate_Edit.EditObj.SetButtonText('btnSubmitgs_TeachingDate', value);
  }
  /**
   * 截止日期 (Used In Clear())
   **/
