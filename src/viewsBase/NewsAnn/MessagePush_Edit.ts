...
import {
  ...
  MessagePush_CheckPropertyNew,
  MessagePush_AddNewRecordWithMaxIdAsync,
  MessagePush_GetUniCondStr,
  MessagePush_IsExistRecordAsync,
  MessagePush_GetUniCondStr4Update,
  MessagePush_IsExistAsync,
  MessagePush_GetObjByMessagePushIdAsync,
  MessagePush_CheckProperty4Update,
  MessagePush_UpdateRecordAsync,
...
export abstract class MessagePush_Edit {
  ...
  public HideDialog_MessagePush() {
    if (MessagePush_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      MessagePush_Edit.EditObj.hideDialog();
    }
  }
  ...
  public async ShowDialog_MessagePush(strOp: string): Promise<boolean> {
    ...
    if (MessagePush_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (MessagePush_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await MessagePush_Edit.EditObj.showDialog();
    }
    this.divEdit = MessagePush_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (MessagePush_Edit.times4TestShowDialog < 2) {
        MessagePush_Edit.times4TestShowDialog++;
        setTimeout(() => {
      ...
      MessagePush_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (MessagePush_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (MessagePush_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGv(clsMessagePushEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
   ...
   **/
  public async GetDataFromMessagePushClass(pobjMessagePushEN: clsMessagePushEN) {
  ...
  public async UpdateRecord(strMessagePushId: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromMessagePushClass(objMessagePushEN);
  ...
  public set btnCancelMessagePush(value: string) {
    MessagePush_Edit.EditObj.SetButtonText('btnCancelMessagePush', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitMessagePush(): string {
    const strValue = MessagePush_Edit.EditObj.GetButtonText('btnSubmitMessagePush');
    return strValue;
  }
  /**
  ...
  public set btnSubmitMessagePush(value: string) {
    MessagePush_Edit.EditObj.SetButtonText('btnSubmitMessagePush', value);
  }
  /**
   * 客户端版本类型Id (Used In Clear())
   **/
  public set clientVersionTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtClientVersionTypeId', value);
  }
  /**
   * 客户端版本类型Id (Used In PutDataToClass())
   **/
  public get clientVersionTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtClientVersionTypeId');
  ...
  public set isAllpush(value: boolean) {
    SetCheckBoxValueByIdInDivObj(this.divEdit, 'chkIsAllpush', value);
  }
  /**
   * 是否全体推送 (Used In PutDataToClass())
   **/
  public get isAllpush(): boolean {
    const bolValue = GetCheckBoxValueInDivObj(this.divEdit, 'chkIsAllpush');
    return bolValue;
  }
  /**
   * 是否接收 (Used In Clear())
  ...
  public set messageContent(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMessageContent', value);
  }
  /**
   * 消息内容 (Used In PutDataToClass())
   **/
  public get messageContent(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMessageContent');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set messagePushId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMessagePushId', value);
  }
  /**
   * 消息Id (Used In PutDataToClass())
   **/
  public get messagePushId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMessagePushId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set messagePushNumber(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMessagePushNumber', value);
  }
  /**
   * 消息编号 (Used In PutDataToClass())
   **/
  public get messagePushNumber(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMessagePushNumber');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set messageTitle(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMessageTitle', value);
  }
  /**
   * 消息标题 (Used In PutDataToClass())
   **/
  public get messageTitle(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMessageTitle');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set messageTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtMessageTypeId', value);
  }
  /**
   * 消息类型Id (Used In PutDataToClass())
   **/
  public get messageTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtMessageTypeId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set receivePeople(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtReceivePeople', value);
  }
  /**
   * 接收人员 (Used In PutDataToClass())
   **/
  public get receivePeople(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtReceivePeople');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
