...
import {
  ...
  AcademicJournals_CheckPropertyNew,
  AcademicJournals_AddNewRecordWithMaxIdAsync,
  AcademicJournals_ReFreshCache,
  AcademicJournals_GetUniCondStr,
  AcademicJournals_IsExistRecordAsync,
  AcademicJournals_GetUniCondStr4Update,
  AcademicJournals_IsExistAsync,
  AcademicJournals_GetObjByJournalIdAsync,
  AcademicJournals_CheckProperty4Update,
  AcademicJournals_UpdateRecordAsync,
...
export abstract class AcademicJournals_Edit {
  ...
  public static objPageEdit: AcademicJournals_Edit;
  public static objPageEdit2: AcademicJournals_Edit;
  public static objPageEdit3: AcademicJournals_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (AcademicJournals_Edit.SetPageEdit(this, 1) == true) return;
    if (AcademicJournals_Edit.SetPageEdit(this, 2) == true) return;
    if (AcademicJournals_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (AcademicJournals_Edit.objPageEdit == null) {
          AcademicJournals_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = AcademicJournals_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (AcademicJournals_Edit.objPageEdit2 == null) {
          AcademicJournals_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = AcademicJournals_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            AcademicJournals_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (AcademicJournals_Edit.objPageEdit3 == null) {
          AcademicJournals_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = AcademicJournals_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            AcademicJournals_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (AcademicJournals_Edit.objPageEdit != null) {
      const strClassNameOld = AcademicJournals_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return AcademicJournals_Edit.objPageEdit;
    }
    if (AcademicJournals_Edit.objPageEdit2 != null) {
      const strClassNameOld = AcademicJournals_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return AcademicJournals_Edit.objPageEdit2;
    }
    if (AcademicJournals_Edit.objPageEdit3 != null) {
      const strClassNameOld = AcademicJournals_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return AcademicJournals_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_AcademicJournals() {
    if (AcademicJournals_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      AcademicJournals_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_AcademicJournals(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_AcademicJournals.name;
    if (AcademicJournals_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (AcademicJournals_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await AcademicJournals_Edit.EditObj.showDialog();
    }
    this.divEdit = AcademicJournals_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (AcademicJournals_Edit.times4TestShowDialog < 2) {
        AcademicJournals_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_AcademicJournals(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      AcademicJournals_Edit.times4TestShowDialog = 0;
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitAcademicJournals = '确认添加';
      this.btnCancelAcademicJournals = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitAcademicJournals = '确认修改';
      this.btnCancelAcademicJournals = '取消修改';
    }
    return true;
  }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (AcademicJournals_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (AcademicJournals_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_AcademicJournals(this.opType);
  ...
  public async SetDdl_JournalSubjectIdInDiv() {
    await JournalSubject_BindDdl_JournalSubjectIdInDivCache(this.divEdit, 'ddlJournalSubjectId'); //
  }
  ...
  public async btnSubmit_Click() {
    ...
    const strCommandText: string = this.btnSubmitAcademicJournals;
    try {
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (IsNullOrEmpty(returnKeyId) == false) {
              ...
              this.iShowList.BindGvCache(clsAcademicJournalsEN._CurrTabName, returnKeyId);
            }
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsAcademicJournalsEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public Clear() {
    this.journalId = '';
    this.journalName = '';
    ClearSelectValueByIdInDivObj(this.divEdit, 'ddlJournalSubjectCategoryId');
    ClearSelectValueByIdInDivObj(this.divEdit, 'ddlJournalSubjectId');
    this.memo = '';
  }
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucAcademicJournalsB1.journalId = AcademicJournalsGetMaxStrId_S();
    try {
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.journalId = await AcademicJournals_GetMaxStrIdAsync();
    try {
      const returnString = await AcademicJournals_GetMaxStrIdAsync();
      if (returnString == '') {
        const strInfo = Format('获取表AcademicJournals的最大关键字为空,不成功,请检查!');
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objAcademicJournalsEN);
   ...
   **/
  public async CheckUniCond4Add(objAcademicJournalsEN: clsAcademicJournalsEN): Promise<boolean> {
    const strUniquenessCondition = AcademicJournals_GetUniCondStr(objAcademicJournalsEN);
   ...
   **/
  public async CheckUniCond4Update(objAcademicJournalsEN: clsAcademicJournalsEN): Promise<boolean> {
    const strUniquenessCondition = AcademicJournals_GetUniCondStr4Update(objAcademicJournalsEN);
    const bolIsExistCondition = await AcademicJournals_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async AddNewRecordWithMaxIdSave(): Promise<string> {
    ...
    try {
      ...
      const responseKeyId = await AcademicJournals_AddNewRecordWithMaxIdAsync(
        objAcademicJournalsEN,
      );
  ...
  public async ShowData(strJournalId: string) {
    ...
    try {
      const objAcademicJournalsENConst = await AcademicJournals_GetObjByJournalIdAsync(
        strJournalId,
      );
      if (objAcademicJournalsENConst == null) {
        const strMsg = Format(
      ...
      objAcademicJournalsEN = objAcademicJournalsENConst;
    } catch (e) {
      const strMsg = Format(
   ...
   **/
  public async GetDataFromAcademicJournalsClass(pobjAcademicJournalsEN: clsAcademicJournalsEN) {
  ...
  public async UpdateRecord(strJournalId: string): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromAcademicJournalsClass(objAcademicJournalsEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    const objAcademicJournalsEN = new clsAcademicJournalsEN();
    objAcademicJournalsEN.SetJournalId(this.keyId);
    await this.PutDataToAcademicJournalsClass(objAcademicJournalsEN);
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objAcademicJournalsEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelAcademicJournals(value: string) {
    AcademicJournals_Edit.EditObj.SetButtonText('btnCancelAcademicJournals', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitAcademicJournals(): string {
    const strValue = AcademicJournals_Edit.EditObj.GetButtonText('btnSubmitAcademicJournals');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitAcademicJournals(value: string) {
    AcademicJournals_Edit.EditObj.SetButtonText('btnSubmitAcademicJournals', value);
  }
  /**
   * 期刊Id (Used In Clear())
   **/
  public set journalId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtJournalId', value);
  }
  /**
   * 期刊Id (Used In PutDataToClass())
   **/
  public get journalId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtJournalId');
  ...
  public set journalName(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtJournalName', value);
  }
  /**
   * 期刊名称 (Used In PutDataToClass())
   **/
  public get journalName(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtJournalName');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set journalSubjectCategoryId(value: string) {
    SetSelectValueByIdInDivObj(this.divEdit, 'ddlJournalSubjectCategoryId', value);
  }
  /**
   * 期刊学科门类Id (Used In PutDataToClass())
   **/
  public get journalSubjectCategoryId(): string {
    const strValue = GetSelectValueInDivObj(this.divEdit, 'ddlJournalSubjectCategoryId');
    if (strValue == undefined) return '';
  ...
  public set journalSubjectId(value: string) {
    SetSelectValueByIdInDivObj(this.divEdit, 'ddlJournalSubjectId', value);
  }
  /**
   * 期刊学科Id (Used In PutDataToClass())
   **/
  public get journalSubjectId(): string {
    const strValue = GetSelectValueInDivObj(this.divEdit, 'ddlJournalSubjectId');
    if (strValue == undefined) return '';
    else if (strValue == '0') return '';
    else return strValue;
  }
