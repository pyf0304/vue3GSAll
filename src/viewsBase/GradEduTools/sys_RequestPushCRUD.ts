...
//import $ from "jquery";
import {
  sys_RequestPush_GetRecCountByCondCache,
  sys_RequestPush_GetSubObjLstCache,
  sys_RequestPush_DelRecordAsync,
  sys_RequestPush_ReFreshCache,
  sys_RequestPush_GetObjByRequestIdAsync,
  sys_RequestPush_GetObjLstByRequestIdLstAsync,
  sys_RequestPush_AddNewRecordAsync,
  sys_RequestPush_Delsys_RequestPushsAsync,
...
import {
  sys_RequestPushEx_FuncMapByFldName,
  sys_RequestPushEx_GetObjExLstByPagerCache,
} from '@/ts/L3ForWApiEx/GradEduTools/clssys_RequestPushExWApi';
...
export abstract class sys_RequestPushCRUD implements clsOperateList {
  ...
  public async PageLoadCache() {
    ...
    try {
      ...
      this.SetEventFunc();
      if (sys_RequestPushCRUD.sortsys_RequestPushBy == '')
        sys_RequestPushCRUD.sortsys_RequestPushBy = 'receiveUser Asc';
      //2、显示无条件的表内容在GridView中
      await this.BindGv_sys_RequestPush4Func(this.divList);
    } catch (e) {
   ...
   **/
  public CombineData(
    arrsys_RequestPushObjLst: Array<clssys_RequestPushEN>,
    ...
    const strFileName = Format('请求推送表({0})导出.xlsx', clssys_RequestPushEN._CurrTabName);
   ...
   **/
  public async ExportExcel_sys_RequestPushCache() {
    const strThisFuncName = this.ExportExcel_sys_RequestPushCache.name;
    if (sys_RequestPushCRUD.sortsys_RequestPushBy == null) {
      const strMsg = Format(
        '在显示列表时,排序字段(sortsys_RequestPushBy)为空,请检查!(In BindGv_sys_RequestPushCache)',
      );
      console.error(strMsg);
      alert(strMsg);
      return;
    }
    const objsys_RequestPushCond = await this.Combinesys_RequestPushConditionObj4ExportExcel();
    let arrsys_RequestPushObjLst: Array<clssys_RequestPushEN> = [];
    try {
      this.recCount = await sys_RequestPush_GetRecCountByCondCache(objsys_RequestPushCond);
      if (this.recCount == 0) {
        const strMsg = Format(
          '在绑定GvCache过程中,根据条件:[{0}]获取的对象列表数为0!',
          objsys_RequestPushCond.whereCond,
        );
        console.error('Error: ', strMsg);
        //console.trace();
        alert(strMsg);
      ...
      arrsys_RequestPushObjLst = await sys_RequestPush_GetSubObjLstCache(objsys_RequestPushCond);
    } catch (e) {
    ...
    try {
      ...
      arrsys_RequestPushObjLst = arrsys_RequestPushObjLst.sort(this.SortFunExportExcel);
  ...
  public async BindDdl4QueryRegion() {
    const CourseIdStatic = sys_RequestPushCRUD.CourseIdStatic; //静态变量;//静态变量
  ...
  public async btnExportExcel_Click() {
    await this.ExportExcel_sys_RequestPushCache();
  }
  ...
  public async Combinesys_RequestPushCondition(): Promise<string> {
    ...
    try {
      ...
      const strMsg: string = Format(
        '(errid:WiTsCs0017)在组合查询条件(Combinesys_RequestPushCondition)时出错!请联系管理员!{0}',
        objException,
      );
      throw strMsg;
    }
  ...
  public async Combinesys_RequestPushConditionObj(): Promise<clssys_RequestPushEN> {
    ...
    try {
      if (this.receiveUser_q != '') {
        ...
        objsys_RequestPushCond.SetCondFldValue(
          clssys_RequestPushEN.con_ReceiveUser,
          this.receiveUser_q,
          'like',
        );
      ...
      const strMsg: string = Format(
        '(errid:WiTsCs0018)在组合查询条件对象(Combinesys_RequestPushConditionObj)时出错!请联系管理员!{0}',
        objException,
      );
      throw strMsg;
    }
    objsys_RequestPushCond.whereCond = strWhereCond;
    return objsys_RequestPushCond;
  }
  ...
  public async Combinesys_RequestPushConditionObj4ExportExcel(): Promise<clssys_RequestPushEN> {
    ...
    //例如 1 = 1 && UserName = '张三'
    let strWhereCond = ' 1 = 1 ';
    const objsys_RequestPushCond = new clssys_RequestPushENEx();
    //如果该条件控件的内容不为空,就组成一个条件并添加到总条件串中。
    try {
      if (this.receiveUser_q != '') {
        strWhereCond += Format(
      ...
      const strMsg: string = Format(
        '(errid:WiTsCs0019)在组合导出Excel条件对象(Combinesys_RequestPushConditionObj4ExportExcel)时出错!请联系管理员!{0}',
        objException,
      );
      throw strMsg;
    }
   ...
   **/
  public async BindTab_sys_RequestPush(
    ...
    const arrDataColumn: Array<clsDataColumn> = [
      ...
      {
        fldName: clssys_RequestPushEN.con_ReceiveUser,
        sortBy: 'userName',
        sortFun: SortFun,
        getDataSource: '',
        colHeader: '接收用户',
   ...
   **/
  public async BindGv_sys_RequestPushCache(divList: HTMLDivElement) {
    const strThisFuncName = this.BindGv_sys_RequestPushCache.name;
    if (sys_RequestPushCRUD.sortsys_RequestPushBy == null) {
      const strMsg = Format(
        '在显示列表时,排序字段(sortsys_RequestPushBy)为空,请检查!(In BindGv_sys_RequestPushCache)',
      );
    ...
    const objsys_RequestPushCond = await this.Combinesys_RequestPushConditionObj();
    const strWhereCond = JSON.stringify(objsys_RequestPushCond);
    ...
    try {
      ...
      if (sys_RequestPushCRUD.sortFunStatic != undefined) {
        strSortFun = sys_RequestPushCRUD.sortFunStatic(sys_RequestPushCRUD.ascOrDesc4SortFun);
      }
    ...
    try {
      await this.BindTab_sys_RequestPush(divList, arrsys_RequestPushExObjLst);
      //console.log("完成BindGv_sys_RequestPushCache!");
    } catch (e) {
      const strMsg = `绑定${this.thisTabName}对象列表不成功, ${e}.(in ${this.constructor.name}.${strThisFuncName}`;
      console.error(strMsg);
      alert(strMsg);
  ...
  public async BindGv_sys_RequestPush4Func(divList: HTMLDivElement) {
    ...
    try {
      await this.BindTab_sys_RequestPush4Func(divList, arrsys_RequestPushExObjLst);
      //console.log("完成BindGv_sys_RequestPush4Func!");
    } catch (e) {
      const strMsg = `绑定${this.thisTabName}对象列表不成功, ${e}.(in ${this.constructor.name}.${strThisFuncName})`;
      console.error(strMsg);
      alert(strMsg);
   ...
   * @returns 返回两个对象比较的结果
   **/
  public SortFunExportExcel(a: clssys_RequestPushEN, b: clssys_RequestPushEN): number {
    if (a.idCurrEduCls == b.idCurrEduCls) return a.idCurrEduCls.localeCompare(b.idCurrEduCls);
  ...
  public async SortBy(objAnchorElement: any) {
    ...
    const { sortFun, ascOrDesc4SortFun, sortBy } = GetSortBy(
      objAnchorElement,
      sys_RequestPushCRUD.ascOrDesc4SortFun,
    ...
    sys_RequestPushCRUD.sortFunStatic = sortFun;
    await this.BindGv_sys_RequestPush4Func(this.divList);
  }
  ...
  public async CopyRecord(arrRequestId: Array<string>) {
    ...
    try {
      const arrsys_RequestPushObjLst = await sys_RequestPush_GetObjLstByRequestIdLstAsync(
        arrRequestId,
      );
  ...
  public async DelMultiRecord(arrRequestId: Array<string>) {
    ...
    try {
      ...
      if (returnInt > 0) {
        for (const lngRequestId of arrRequestId) {
          sys_RequestPush_ReFreshCache();
        }
        const strInfo = `删除${this.thisTabName}记录成功,共删除${returnInt}条记录!`;
        //显示信息框
