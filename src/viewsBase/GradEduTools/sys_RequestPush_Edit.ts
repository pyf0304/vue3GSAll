...
import {
  sys_RequestPush_CheckPropertyNew,
  sys_RequestPush_AddNewRecordAsync,
  sys_RequestPush_ReFreshCache,
  sys_RequestPush_GetUniCondStr,
  sys_RequestPush_IsExistRecordAsync,
  sys_RequestPush_GetUniCondStr4Update,
  sys_RequestPush_IsExistAsync,
  sys_RequestPush_GetObjByRequestIdAsync,
  sys_RequestPush_CheckProperty4Update,
...
export abstract class sys_RequestPush_Edit {
  ...
  public static objPageEdit: sys_RequestPush_Edit;
  public static objPageEdit2: sys_RequestPush_Edit;
  public static objPageEdit3: sys_RequestPush_Edit;
  ...
  constructor(strClassName: string, objShowList: IShowList) {
    ...
    if (sys_RequestPush_Edit.SetPageEdit(this, 1) == true) return;
    if (sys_RequestPush_Edit.SetPageEdit(this, 2) == true) return;
    if (sys_RequestPush_Edit.SetPageEdit(this, 3) == true) return;
  }
  public static SetPageEdit(objDataLst: any, intIndex: number): boolean {
    const strNewClassName = objDataLst.className;
    switch (intIndex) {
      case 1:
        if (sys_RequestPush_Edit.objPageEdit == null) {
          sys_RequestPush_Edit.objPageEdit = objDataLst;
          return true;
        } else {
          const strClassNameOld = sys_RequestPush_Edit.objPageEdit.className;
        ...
        break;
      case 2:
        if (sys_RequestPush_Edit.objPageEdit2 == null) {
          sys_RequestPush_Edit.objPageEdit2 = objDataLst;
          return true;
        } else {
          const strClassNameOld = sys_RequestPush_Edit.objPageEdit2.className;
          if (strClassNameOld == strNewClassName) {
            sys_RequestPush_Edit.objPageEdit2 = objDataLst;
            return true;
          } else return false;
        ...
        break;
      case 3:
        if (sys_RequestPush_Edit.objPageEdit3 == null) {
          sys_RequestPush_Edit.objPageEdit3 = objDataLst;
          return true;
        } else {
          const strClassNameOld = sys_RequestPush_Edit.objPageEdit3.className;
          if (strClassNameOld == strNewClassName) {
            sys_RequestPush_Edit.objPageEdit3 = objDataLst;
            return true;
          } else return false;
  ...
  public static GetPageEditObj(strClassName: string): any {
    if (sys_RequestPush_Edit.objPageEdit != null) {
      const strClassNameOld = sys_RequestPush_Edit.objPageEdit.className;
      if (strClassNameOld == strClassName) return sys_RequestPush_Edit.objPageEdit;
    }
    if (sys_RequestPush_Edit.objPageEdit2 != null) {
      const strClassNameOld = sys_RequestPush_Edit.objPageEdit2.className;
      if (strClassNameOld == strClassName) return sys_RequestPush_Edit.objPageEdit2;
    }
    if (sys_RequestPush_Edit.objPageEdit3 != null) {
      const strClassNameOld = sys_RequestPush_Edit.objPageEdit3.className;
      if (strClassNameOld == strClassName) return sys_RequestPush_Edit.objPageEdit3;
    }
    return null;
  }
  ...
  public HideDialog_sys_RequestPush() {
    if (sys_RequestPush_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      sys_RequestPush_Edit.EditObj.hideDialog();
    }
  }
   ...
   **/
  public async ShowDialog_sys_RequestPush(strOp: string): Promise<boolean> {
    const strThisFuncName = this.ShowDialog_sys_RequestPush.name;
    if (sys_RequestPush_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      if (sys_RequestPush_Edit.EditObj == null) {
        const strMsg = Format(
      ...
      await sys_RequestPush_Edit.EditObj.showDialog();
    }
    this.divEdit = sys_RequestPush_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (sys_RequestPush_Edit.times4TestShowDialog < 2) {
        sys_RequestPush_Edit.times4TestShowDialog++;
        setTimeout(() => {
          this.ShowDialog_sys_RequestPush(strOp);
        }, 100);
      } else {
        const strMsg = Format(
      ...
      sys_RequestPush_Edit.times4TestShowDialog = 0;
    }
    if (strOp === 'Add' || strOp === 'AddWithMaxId') {
      this.btnSubmitsys_RequestPush = '确认添加';
      this.btnCancelsys_RequestPush = '取消添加';
    } else if (strOp === 'Update') {
      this.btnSubmitsys_RequestPush = '确认修改';
      this.btnCancelsys_RequestPush = '取消修改';
    }
    return true;
  }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (sys_RequestPush_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (sys_RequestPush_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
  ...
  public async btnAddNewRecord_Click() {
    ...
    try {
      this.opType = 'Add';
      const bolIsSuccess = await this.ShowDialog_sys_RequestPush(this.opType);
  ...
  public async BindDdl4EditRegionInDiv() {
    const CourseIdStatic = sys_RequestPush_Edit.CourseIdStatic; //静态变量;//静态变量
  ...
  public async btnSubmit_Click() {
    ...
    const strCommandText: string = this.btnSubmitsys_RequestPush;
    try {
      ...
      switch (strCommandText) {
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            //{
            //sys_RequestPush_Edit.EditObj.hideDialog();
            //this.iShowList.BindGvCache(clssys_RequestPushEN._CurrTabName, "");
            //}
          } else {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clssys_RequestPushEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
  ...
  public async AddNewRecord() {
    ...
    this.Clear();
    //wucsys_RequestPushB1.requestId = sys_RequestPushGetMaxStrId_S();
  }
  ...
  public async AddNewRecordWithMaxId() {
    ...
    //this.requestId = await sys_RequestPush_GetMaxStrIdAsync();
  }
  ...
  public async PutDataTosys_RequestPushClass(pobjsys_RequestPushEN: clssys_RequestPushEN) {
    ...
    pobjsys_RequestPushEN.SetIdCurrEduCls(this.idCurrEduCls); // 当前教学班流水号
  ...
  public async AddNewRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Add(objsys_RequestPushEN);
   ...
   **/
  public async CheckUniCond4Add(objsys_RequestPushEN: clssys_RequestPushEN): Promise<boolean> {
    const strUniquenessCondition = sys_RequestPush_GetUniCondStr(objsys_RequestPushEN);
   ...
   **/
  public async CheckUniCond4Update(objsys_RequestPushEN: clssys_RequestPushEN): Promise<boolean> {
    const strUniquenessCondition = sys_RequestPush_GetUniCondStr4Update(objsys_RequestPushEN);
    const bolIsExistCondition = await sys_RequestPush_IsExistRecordAsync(strUniquenessCondition);
    if (bolIsExistCondition == true) {
      const strMsg = Format(
        '不能满足唯一性条件。满足条件：{0}的记录已经存在!',
  ...
  public async ShowData(lngRequestId: number) {
    ...
    try {
      const objsys_RequestPushENConst = await sys_RequestPush_GetObjByRequestIdAsync(lngRequestId);
      if (objsys_RequestPushENConst == null) {
        const strMsg = Format(
      ...
      objsys_RequestPushEN = objsys_RequestPushENConst;
    } catch (e) {
      const strMsg = Format(
   ...
   **/
  public async GetDataFromsys_RequestPushClass(pobjsys_RequestPushEN: clssys_RequestPushEN) {
    ...
    this.idCurrEduCls = pobjsys_RequestPushEN.idCurrEduCls; // 当前教学班流水号
  ...
  public async UpdateRecord(lngRequestId: number): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromsys_RequestPushClass(objsys_RequestPushEN);
  ...
  public async UpdateRecordSave(): Promise<boolean> {
    ...
    try {
      //检查唯一性条件
      const bolIsExistCond = await this.CheckUniCond4Update(objsys_RequestPushEN);
      if (bolIsExistCond == false) {
        return false;
      }
   ...
   **/
  public set btnCancelsys_RequestPush(value: string) {
    sys_RequestPush_Edit.EditObj.SetButtonText('btnCancelsys_RequestPush', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitsys_RequestPush(): string {
    const strValue = sys_RequestPush_Edit.EditObj.GetButtonText('btnSubmitsys_RequestPush');
    return strValue;
  }
  /**
   * 设置确定按钮的标题(Used In AddNewRecord())
   **/
  public set btnSubmitsys_RequestPush(value: string) {
    sys_RequestPush_Edit.EditObj.SetButtonText('btnSubmitsys_RequestPush', value);
  }
  /**
  ...
  public set pushTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtPushTypeId', value);
  }
  /**
   * 推送类型Id (Used In PutDataToClass())
   **/
  public get pushTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtPushTypeId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set requestDate(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtRequestDate', value);
  }
  /**
   * RequestDate (Used In PutDataToClass())
   **/
  public get requestDate(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtRequestDate');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set requestStata(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtRequestStata', value);
  }
  /**
   * RequestStata (Used In PutDataToClass())
   **/
  public get requestStata(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtRequestStata');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set requestUser(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtRequestUser', value);
  }
  /**
   * RequestUser (Used In PutDataToClass())
   **/
  public get requestUser(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtRequestUser');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set requesTypeId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtRequesTypeId', value);
  }
  /**
   * 请求类型Id (Used In PutDataToClass())
   **/
  public get requesTypeId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtRequesTypeId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
