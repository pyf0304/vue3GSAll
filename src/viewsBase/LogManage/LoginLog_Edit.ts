...
export abstract class LoginLog_Edit {
  ...
  public HideDialog_LoginLog() {
    if (LoginLog_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      LoginLog_Edit.EditObj.hideDialog();
    }
  }
  ...
  public async ShowDialog_LoginLog(strOp: string): Promise<boolean> {
    ...
    if (LoginLog_Edit.strPageDispModeId == enumPageDispMode.PopupBox_01) {
      ...
      await LoginLog_Edit.EditObj.showDialog();
    }
    this.divEdit = LoginLog_Edit.EditObj.$refs.refDivEdit;
    if (this.divEdit == null) {
      if (LoginLog_Edit.times4TestShowDialog < 2) {
        LoginLog_Edit.times4TestShowDialog++;
        setTimeout(() => {
      ...
      LoginLog_Edit.times4TestShowDialog = 0;
    }
  ...
  public getDivName(): HTMLDivElement | null {
    ...
    if (LoginLog_Edit.strPageDispModeId != enumPageDispMode.PopupBox_01) {
      ...
      if (LoginLog_Edit.EditObj.dialogVisible == false) {
        const strMsg = Format(
        ...
        case '确认添加':
          ...
          if (this.opType == 'AddWithMaxId') {
            ...
            if (returnBool == true) {
              ...
              this.iShowList.BindGvCache(clsLoginLogEN._CurrTabName, this.keyId);
            }
          }
          break;
        case '确认修改':
   ...
   **/
  public async GetDataFromLoginLogClass(pobjLoginLogEN: clsLoginLogEN) {
  ...
  public async UpdateRecord(lngLoginLogId: number): Promise<boolean> {
    ...
    try {
      ...
      await this.GetDataFromLoginLogClass(objLoginLogEN);
  ...
  public set btnCancelLoginLog(value: string) {
    LoginLog_Edit.EditObj.SetButtonText('btnCancelLoginLog', value);
  }
  /**
   * 获取按钮的标题
   **/
  public get btnSubmitLoginLog(): string {
    const strValue = LoginLog_Edit.EditObj.GetButtonText('btnSubmitLoginLog');
    return strValue;
  }
  /**
  ...
  public set btnSubmitLoginLog(value: string) {
    LoginLog_Edit.EditObj.SetButtonText('btnSubmitLoginLog', value);
  }
  /**
   * FailReason (Used In Clear())
   **/
  public set failReason(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtFailReason', value);
  }
  /**
   * FailReason (Used In PutDataToClass())
   **/
  public get failReason(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtFailReason');
  ...
  public set loginIP(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtLoginIP', value);
  }
  /**
   * LoginIP (Used In PutDataToClass())
   **/
  public get loginIP(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtLoginIP');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set loginLogNumber(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtLoginLogNumber', value);
  }
  /**
   * LoginLogNumber (Used In PutDataToClass())
   **/
  public get loginLogNumber(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtLoginLogNumber');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set loginResult(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtLoginResult', value);
  }
  /**
   * LoginResult (Used In PutDataToClass())
   **/
  public get loginResult(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtLoginResult');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set loginTime(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtLoginTime', value);
  }
  /**
   * LoginTime (Used In PutDataToClass())
   **/
  public get loginTime(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtLoginTime');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set loginUserId(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtLoginUserId', value);
  }
  /**
   * LoginUserId (Used In PutDataToClass())
   **/
  public get loginUserId(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtLoginUserId');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set onlineTime(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtOnlineTime', value);
  }
  /**
   * OnlineTime (Used In PutDataToClass())
   **/
  public get onlineTime(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtOnlineTime');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
  /**
  ...
  public set outTime(value: string) {
    SetInputValueInDivObj(this.divEdit, 'txtOutTime', value);
  }
  /**
   * OutTime (Used In PutDataToClass())
   **/
  public get outTime(): string {
    const strValue = GetInputValueInDivObj(this.divEdit, 'txtOutTime');
    if (strValue == undefined) return '';
    else return strValue.toString();
  }
}
